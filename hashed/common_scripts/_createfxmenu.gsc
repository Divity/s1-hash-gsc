...
_id_5BAA()
{
    ...
    if ( _id_5BA5( "create_loopfx" ) )
        var_5 = _id_A4F0::_id_2428( var_1 );

    if ( _id_5BA5( "create_oneshot" ) )
        var_5 = _id_A4F0::_id_242E( var_1 );
...
_id_378C( var_0 )
{
    var_0._id_9C3A["angles"] = vectortoangles( var_0._id_9C3A["origin"] + ( 0, 0, 100 ) - var_0._id_9C3A["origin"] );
...
_id_5BA7()
{
    ...
    for ( var_3 = 0; var_3 < level._id_0575._id_6549.size; var_3++ )
    {
        ...
        if ( !isdefined( var_2._id_9C3A[var_4["name"]] ) )
            continue;
...
_id_6F12( var_0, var_1 )
{
    ...
    level._id_240D = 1;
    level._id_0575._id_4AE6[var_1 + 1][0]._id_00C5 = ( 1, 1, 0 );
...
_id_0CA5( var_0, var_1 )
{
    ...
    for ( var_2 = 0; var_2 < level._id_0575._id_7C60.size; var_2++ )
    {
        ...
        if ( _id_59CF( var_0["mask"], var_3._id_9C3A["type"] ) )
            var_3._id_9C3A[var_0["name"]] = var_1;
    }
...
_id_4E7A( var_0 )
{
    for (;;)
    {
        ...
        if ( level._id_031D _meth_824C( "escape" ) || level._id_031D _meth_824C( "x" ) )
            break;

        var_1 = 0;

        if ( level._id_031D _meth_824C( "-" ) )
            var_1 = -10;
        else if ( level._id_031D _meth_824C( "=" ) )
            var_1 = 10;
        ...
        if ( var_1 != 0 )
        {
            ...
            {
                if ( isdefined( var_3._id_9C3A["reactive_radius"] ) )
                {
                    var_3._id_9C3A["reactive_radius"] += var_1;
                    var_3._id_9C3A["reactive_radius"] = clamp( var_3._id_9C3A["reactive_radius"], 10, 1000 );
                }
            }
        }
    }
...
_id_2B47( var_0 )
{
    level._id_2410 = 1;
    common_scripts\_createfx::_id_1EB9();
    common_scripts\_createfx::_id_7E3C( "Name: " + var_0._id_9C3A["fxid"] );
    common_scripts\_createfx::_id_7E3C( "Type: " + var_0._id_9C3A["type"] );
    common_scripts\_createfx::_id_7E3C( "Origin: " + var_0._id_9C3A["origin"] );
    common_scripts\_createfx::_id_7E3C( "Angles: " + var_0._id_9C3A["angles"] );
    var_1 = 0;
    var_2 = 0;
    var_3 = 0;
    ...
    for ( var_4 = 0; var_4 < level._id_0575._id_6549.size; var_4++ )
    {
        ...
        if ( isdefined( var_0._id_9C3A[var_5["name"]] ) )
            continue;

        if ( !_id_59CF( var_5["mask"], var_0._id_9C3A["type"] ) )
            continue;
...
_id_0781( var_0 )
{
    ...
    for ( var_2 = 0; var_2 < level._id_0575._id_7C60.size; var_2++ )
    {
        ...
        if ( _id_59CF( var_0["mask"], var_3._id_9C3A["type"] ) )
            var_3._id_9C3A[var_0["name"]] = var_0["default"];
    }
}
...
_id_2B48( var_0 )
{
    ...
    if ( _id_330D() )
    {
        ...
        for ( var_4 = 0; var_4 < level._id_0575._id_6549.size; var_4++ )
        {
            ...
            var_2++;
            common_scripts\_createfx::_id_7E3C( var_2 + ". " + var_5["description"] + ": " + var_0._id_9C3A[var_5["name"]] );
    ...
    else
    {
        ...
        for ( var_4 = 0; var_4 < level._id_0575._id_6549.size; var_4++ )
        {
            ...
            var_1++;
            common_scripts\_createfx::_id_7E3C( var_5["description"] + ": " + var_0._id_9C3A[var_5["name"]] );
...
_id_7C54()
{
    ...
    {
        if ( issubstr( var_7._id_9C3A["fxid"], var_1 ) )
