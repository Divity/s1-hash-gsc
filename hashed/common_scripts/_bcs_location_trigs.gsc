...
_id_1349()
{
    if ( isdefined( level._id_25F9 ) && isdefined( anim._id_134A ) )
        return;
...
_id_1355()
{
    ...
    {
        if ( isdefined( var_3._id_00AB ) && issubstr( var_3._id_00AB, "trigger_multiple_bcs" ) )
            var_1[var_1.size] = var_3;
    }

    foreach ( var_3 in var_1 )
    {
        if ( !isdefined( level._id_1347[var_3._id_00AB] ) )
            continue;

        var_6 = _id_6695( level._id_1347[var_3._id_00AB] );

        if ( var_6.size > 1 )
            var_6 = _id_A4F0::_id_0CF5( var_6 );

        var_3._id_57F8 = var_6;
    }
