...
_id_4E24()
{
    ...
    level._id_6554 = getentarray( "orbital_node_covered", "targetname" );
}
...
_id_40EA( var_0 )
{
    return var_0._id_02E6 + ( 0, 0, 24000 );
}
...
_id_6CA8( var_0 )
{
    var_1 = anglestoforward( self _meth_833B() );
    ...
    var_13 = spawnstruct();
    var_13._id_02E6 = var_6;
    var_14 = _id_A7B5::_id_3F85( "remoteMissileSpawn", "targetname" );
...
_id_6134( var_0 )
{
    return isdefined( var_0._id_04D8 );
}

_id_6135( var_0 )
{
    return _id_6134( var_0 ) && _func_2C8( var_0 ) && _func_2C9( var_0 ) == "up" || isdefined( var_0._id_13B1 );
}

_id_6133( var_0 )
{
    return _id_6134( var_0 ) && _func_2C8( var_0 ) || isdefined( var_0._id_13B1 ) || isdefined( var_0._id_13B0 );
}
...
_id_613A( var_0, var_1 )
{
    ...
    var_3 = _id_7324( var_2, var_0._id_02E6, var_1 );
...
_id_6132( var_0, var_1 )
{
    ...
    if ( _id_6134( var_0 ) && _func_2C8( var_0 ) )
    {
        var_3 = _func_2C9( var_0 );

        foreach ( var_5 in var_1 )
        {
            if ( isdefined( var_5._id_039B ) && var_5._id_039B == var_3 )
                var_2 = var_5;
        }
    }
    ...
    var_7 = vectornormalize( var_2._id_02E6 - var_0._id_02E6 );
    return var_0._id_02E6 + var_7 * 24000;
}

_id_612F( var_0, var_1, var_2 )
{
    var_1 = sortbydistance( var_1, var_0._id_02E6 );

    foreach ( var_4 in var_1 )
    {
        var_5 = _id_7324( var_4._id_02E6, var_0._id_02E6, var_2 );
...
{
    if ( orbitalbadlandingcheck( var_0._id_02E6 ) )
        return 0;

    if ( isdefined( var_1 ) && var_1 == "goliath" )
    {
        if ( _id_426C( var_0._id_02E6 ) )
            return 0;
    }
...
_id_1B9F( var_0, var_1, var_2 )
{
    ...
    foreach ( var_6 in level._id_655A )
    {
        ...
        var_8 = var_7 * var_7;
        var_9 = _func_220( var_6._id_02E6, var_0 );
...
_id_6CA7( var_0, var_1 )
{
    if ( !isdefined( var_0 ) )
    {
        ...
        var_4 = anglestoforward( self._id_0041 );
    ...
    if ( var_8 )
        var_8 = _id_612D( var_7, var_1 ) && _id_1B9F( var_7._id_02E6, self, var_1 );
    ...
    if ( !isdefined( var_7 ) )
    {
        var_7 = _id_6CA4( 500, 100, self._id_02E6, 0, 1, var_1 );

        if ( !isdefined( var_7 ) )
            var_7 = _id_6CA4( 500, 0, self._id_02E6, 0, 0, var_1 );
...
{
    if ( isdefined( level._id_6554 ) && level._id_6554.size > 0 )
    {
        var_1 = 0;

        foreach ( var_3 in level._id_6554 )
        {
...
_id_426C( var_0 )
{
    ...
    {
        foreach ( var_2 in level._id_425C )
        {
...
_id_6CA0( var_0, var_1, var_2, var_3, var_4 )
{
    while ( var_1 < var_2 && var_4._id_5A41 > 0 )
    {
        ...
        if ( isdefined( var_5 ) )
        {
            ...
            var_7 = var_5._id_02E6 + ( 0, 0, 6 );
            var_8 = bullettrace( var_6, var_7, 0, self );
            var_9 = var_8["fraction"] == 1 && _id_1B9F( var_5._id_02E6, self, var_3 );

            if ( var_9 )
                return var_5;

            var_1 = distance( var_0, var_5._id_02E6 ) + 1;
            continue;
        }
...
_id_6C9E( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( orbitalbadlandingcheck( var_2._id_02E6 ) )
            return undefined;

        if ( var_1 == "goliath" )
        {
            if ( _id_426C( var_2._id_02E6 ) )
                return undefined;
        }
...
_id_1D13( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_7 ) )
        {
            ...
            if ( !_id_1B9F( var_7._id_02E6, var_1, var_2 ) )
            {
                var_7._id_612E = 1;
...
_id_0804( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    for ( var_6 = 0; var_6 < var_0._id_60D5.size; var_6++ )
    {
        ...
        if ( !isdefined( var_7._id_612E ) )
        {
            ...
            if ( var_8 )
            {
                var_9 = distancesquared( var_7._id_02E6, var_4._id_02E6 );
                var_8 = var_9 < var_3;
            }
...
_id_6CA5( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    for ( var_8 = 0; var_8 < var_7.size; var_8++ )
    {
        ...
        if ( var_4 )
            var_6 &= _id_6D92( var_7[var_8]._id_02E6 );
...
{
    var_1 = cos( 60 );
    var_2 = vectornormalize( ( var_0[0], var_0[1], 0 ) - ( self._id_02E6[0], self._id_02E6[1], 0 ) );
    var_3 = anglestoforward( ( 0, self._id_0041[1], 0 ) );
...
_id_0546( var_0 )
{
    ...
    level._id_655A = _id_A4F0::_id_0CF6( level._id_655A, var_0 );
}
