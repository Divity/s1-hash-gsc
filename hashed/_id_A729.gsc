...
_id_2713()
{
    ...
    for (;;)
    {
        ...
        while ( !level._id_6329 _meth_824C( "BUTTON_Y" ) )
            wait 0.05;

        level._id_6329 _meth_809A( "mouse_click" );
...
_id_71DD()
{
    ...
    wait 0.5;
    var_1 = getarraykeys( level._id_1E36 );
    var_2 = [];
...
_id_60B3( var_0, var_1, var_2 )
{
    ...
    var_4 = vectornormalize( anglestoforward( var_3._id_0041 ) ) * 40;
    level._id_70B0[var_0] = [];
    level._id_70B1[var_0]["view_start"] = var_1;
    level._id_70B1[var_0]["view_pos"] = var_3._id_02E6 + var_4;
    level._id_70B1[var_0]["player_view_pos"] = var_3._id_02E6;
    level._id_70B1[var_0]["view_angles"] = var_3._id_0041;
}
...
_id_60B2( var_0, var_1, var_2, var_3 )
{
    ...
    var_6 = spawnstruct();
    var_6._id_6E54 = var_4._id_02E6;
    var_6._id_0245 = var_1;
    var_6._id_397A = 1;
    var_6._id_3979 = ( 0.5, 0.5, 1 );
...
_id_9B5E()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_2 in level._id_70B0[level._id_70AE] )
        {
            ...
            var_2._id_3979 = ( 0.5, 0.5, 1 );
        }

        if ( isdefined( level._id_0712 ) )
        {
            level._id_0712._id_3979 = ( 1, 1, 0.5 );

            if ( isdefined( var_0 ) && var_0 != level._id_0712 )
                level._id_6329 _meth_809A( "mouse_over" );
        }
...
_id_A24D()
{
    ...
    for (;;)
    {
        ...
        while ( !level._id_6329 _meth_824C( "BUTTON_A" ) )
            wait 0.05;
...
_id_A1F8()
{
    ...
    for (;;)
    {
        ...
        while ( !level._id_6329 _meth_824C( "BUTTON_X" ) )
            wait 0.05;
...
_id_185F( var_0 )
{
    ...
    for ( level._id_9E0B[var_0][level._id_9E0B[var_0].size] = var_1; isdefined( var_1 ) && isdefined( var_1._id_04A5 ); var_1 = var_2 )
    {
...
_id_423A( var_0 )
{
    if ( !isdefined( level._id_2FC0 ) )
    {
        ...
        level._id_2FC0 = spawn( "script_model", var_1._id_02E6 );
        level._id_2FC0._id_0041 = var_1._id_0041;
        self _meth_8338( level._id_2FC0._id_02E6 - ( 0, 0, 65 ) );
        self _meth_804D( level._id_2FC0 );
        wait 0.05;
        self _meth_833A( level._id_2FC0._id_0041 );
        thread _id_399F();
    }

    var_2 = 1;
    var_3 = abs( distance( level._id_2FC0._id_02E6, level._id_9E0B[var_0][level._id_9E0B[var_0].size - 1]._id_02E6 ) );
    var_2 *= var_3 / 1200;
    var_2 = max( var_2, 0.1 );
    var_4 = var_2;
    ...
    foreach ( var_7, var_6 in level._id_9E0B[var_0] )
    {
        ...
        level._id_2FC0 _meth_82AE( var_6._id_02E6, var_2, var_2 * 0.5, 0 );
        level._id_2FC0 _meth_82B5( var_6._id_0041, var_2, var_2 * 0.5, 0 );
        wait(var_2);
    }
}
...
{
    var_2 = 1;
    var_3 = abs( distance( level._id_2FC0._id_02E6, level._id_70B1[var_1]["player_view_pos"] ) );
    var_2 *= var_3 / 1200;
    var_2 = max( var_2, 0.1 );
    var_4 = var_2;
    ...
    if ( !1 )
    {
        for ( var_5 = level._id_9E0B[var_0].size - 1; var_5 >= 0; var_5-- )
        {
            ...
            level._id_2FC0 _meth_82AE( var_6._id_02E6, var_2 );
            level._id_2FC0 _meth_82B5( var_6._id_0041, var_2 );
            wait(var_2);
        }
    }
    ...
    level._id_2FC0 _meth_82AE( var_7, var_2, var_2 * 0.5, 0 );
...
_id_9722( var_0 )
{
    self _meth_82D9( 20, ( var_0 + 0.2 ) / 2 );
    self _meth_82D9( 0, ( var_0 + 0.2 ) / 2 );
