...
_id_6124( var_0 )
{
    return var_0._id_04D8 == "Path" && _func_20C( var_0, 1 ) && !var_0 _meth_8386() || isdefined( var_0.forceenableaerialnode ) && var_0.forceenableaerialnode;
}
...
_id_19C5()
{
    ...
    foreach ( var_3 in var_1 )
    {
        if ( _id_6124( var_3 ) )
        {
            ...
            {
                if ( _id_6124( var_6 ) && !_id_A4F0::_id_0CE4( var_3._id_0889, var_6 ) )
                {
                    ...
                    if ( !_id_A4F0::_id_0CE4( var_6._id_0889, var_3 ) )
    ...
    if ( !0 )
    {
        ...
        for ( var_14 = 0; var_14 < var_9.size; var_14++ )
        {
            ...
            foreach ( var_3 in var_9[var_14] )
            {
                for ( var_16 = var_14 + 1; var_16 < var_9.size; var_16++ )
                {
                    ...
                    {
                        var_20 = distance( var_3._id_02E6, var_19._id_02E6 );
                        ...
                        if ( !var_21 )
                        {
                            if ( isdefined( level._id_088D ) )
                            {
                                ...
                                {
                                    var_25 = squared( var_24._id_0354 );

                                    if ( _func_220( var_24._id_02E6, var_3._id_02E6 ) < var_25 && _func_220( var_24._id_02E6, var_19._id_02E6 ) < var_25 )
                                    {
                                        var_22 = 1;
                                        break;
                                    }
                        ...
                        if ( var_21 && var_27 )
                        {
                            ...
                            var_17 = _id_A4F0::_id_0D06( var_17, ::_id_505A );
                            continue;
                        }
        ...
        for ( var_14 = 0; var_14 < var_9.size; var_14++ )
        {
            for ( var_16 = var_14 + 1; var_16 < var_9.size; var_16++ )
            {
                ...
                var_12[var_14][var_16] = _id_A4F0::_id_0D06( var_12[var_14][var_16], ::_id_505A, 150 );
            ...
            for ( var_16 = var_14 + 1; var_16 < var_9.size; var_16++ )
            {
                foreach ( var_38 in var_12[var_14][var_16] )
                {
                    ...
                    if ( !_id_612A( var_39, var_40 ) )
                    {
                        ...
                        {
                            var_43 = playerphysicstrace( var_39._id_02E6 + var_34, var_40._id_02E6 + var_34 );
                            var_36++;
                            var_44 = distancesquared( var_43, var_40._id_02E6 + var_34 ) < 1;

                            if ( !var_44 && var_38[2] == -1 )
                                var_44 = bullettracepassed( var_39._id_02E6 + var_34, var_40._id_02E6 + var_34, 0, undefined );
        ...
        if ( 0 )
        {
            var_9 = _id_A4F0::_id_0D06( var_9, ::_id_5031 );
        ...
        for ( var_14 = 0; var_14 < var_9.size; var_14++ )
        {
            if ( var_9[var_14].size < 0.1 * var_50 )
            {
                foreach ( var_3 in var_9[var_14] )
                {
                    level._id_088C = _id_A4F0::_id_0CF6( level._id_088C, var_3 );
...
_id_3D52( var_0, var_1 )
{
    ...
    var_2 = getnodesinradiussorted( self._id_02E6, var_0, var_1, _id_3CB0()[2] * 2, "path" );
...
_id_376A( var_0, var_1 )
{
    ...
    {
        var_4 = var_2[0];
        var_2 = _id_A4F0::_id_0CF6( var_2, var_4 );

        foreach ( var_6 in var_4._id_0889 )
        {
            if ( !isdefined( var_6._id_66CD ) )
            {
                var_6._id_66CD = _id_A4F0::_id_0CDA( var_4._id_66CD, var_4 );
    ...
    var_8 = _id_A4F0::_id_0CDA( var_1._id_66CD, var_1 );
