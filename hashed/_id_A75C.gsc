...
_id_806D()
{
    ...
    var_0._id_197B = 0;
    var_0._id_1992 = ( -0.02, 0, -0.08 );
    var_0._id_1994 = ( 0.05, 0, -0.06 );
    var_0._id_1A33 = 0.25;
    var_0._id_1A45 = 10;
    var_0._id_5F71 = 150;
    var_0._id_0BA4 = 800;
...
_id_7DD5()
{
    if ( isdefined( level._id_1A3E._id_01C1 ) )
    {
        if ( level._id_1A3E._id_01C1 == "moving" || level._id_1A3E._id_01C1 == "finding_new_position" || level._id_9EA2[level._id_9E99] != level._id_9EA2[level._id_63BB] )
            return;
    }

    if ( isdefined( level._id_1A3E._id_1A13._id_2569 ) && level._id_1A3E._id_1A13._id_2569 == 1 )
        return;

    var_0 = self;

    if ( isdefined( level._id_1A3E._id_1A13.goal_location ) )
        var_1 = level._id_1A3E._id_1A13.goal_location;
    else
    {
        var_2 = level._id_9EA2[level._id_63BB];
        var_3 = var_2 _meth_8180( "TAG_STOWED_BACK" );
        var_4 = distance2d( var_3, var_2._id_117A._id_02E6 );
        var_5 = var_2._id_117A._id_02E6 + anglestoforward( var_2._id_117A._id_0041 ) * var_4;
        var_1 = ( var_5[0], var_5[1], var_3[2] );
    }

    var_6 = _id_1CF6( level._id_1A3E._id_1A13, var_1, 1.5 );

    if ( var_6 == 1 )
        var_7 = var_1;
    else
        var_7 = level._id_1A3E._id_1A13._id_02E6;

    var_8 = distance( level._id_9EA2[level._id_63BB] _meth_8180( "j_spine4" ), var_7 );
...
_id_9EA8()
{
    ...
    var_2 = var_0._id_0041;
    var_3 = var_1 - ( 0, 0, 30 );
    var_0 _id_806D();
    var_0 _id_9EA7();
    var_4 = anglestoforward( var_0._id_0041 );
    var_5 = anglestoright( var_0._id_0041 );
    var_6 = var_4;
    ...
    level._id_9E99 = 0;
    level._id_9E9F = 0;
    var_0._id_04A8 = "spectator";
    var_11 = "iw5_hbra3_mp";
    var_12 = "iw5_hbra3";

    if ( isdefined( var_0._id_0257["customClasses"][0]["primary"] ) && var_0._id_0257["customClasses"][0]["primary"] != "none" )
    {
        var_13 = var_0._id_0257["customClasses"][0]["primary"];
        var_14 = var_0._id_0257["customClasses"][0]["primaryAttachment1"];
        var_15 = var_0._id_0257["customClasses"][0]["primaryAttachment2"];
        var_16 = var_0._id_0257["customClasses"][0]["primaryAttachment3"];
        var_17 = var_0._id_0257["customClasses"][0]["primaryCamo"];
        var_18 = var_0._id_0257["customClasses"][0]["primaryReticule"];
        ...
        var_11 = _id_A781::_id_188C( var_13, var_14, var_15, var_16, var_17, var_18 );
        var_12 = var_0._id_0257["customClasses"][0]["primary"];
    }
    else if ( isdefined( var_0._id_0343 ) )
    {
        var_11 = var_0._id_0343;
        var_12 = var_0._id_030D["primaryWeapon"];
    }
    ...
    if ( !var_9 )
    {
        ...
        var_0 _id_88C8( var_0._id_117A, var_11, var_0._id_03B3, var_12, var_0._id_57D8, var_0._id_57DA, var_0._id_030B, var_0._id_7DA6, var_0._id_02AB, var_20, 0 );
        _func_2D4( level._id_9EA2[var_20], var_8 );
        thread _id_834B();
    }
    else
        level._id_6085 = 1;
    ...
    var_0._id_1B06 = var_0 _id_88C8( var_19, var_11, var_0._id_03B3, var_12, var_0._id_57D8, var_0._id_57DA, var_0._id_030B, var_0._id_7DA6, var_0._id_02AB, 0, 1 );
    _func_2D4( var_0._id_1B06, var_8 );
    ...
    {
        var_23 = maps\mp\gametypes\vlobby::_id_40D0( var_21[var_22] );
        var_0.clan_agents[var_22] = var_0 _id_88C8( var_23, var_11, var_0._id_03B3, var_12, var_0._id_57D8, var_0._id_57DA, var_0._id_030B, var_0._id_7DA6, var_0._id_02AB, 0, 0, 1 );
    ...
    _id_8F0C( var_27 );
    var_28 = 400;
    var_0._id_1A13 = var_27;
    var_27._id_031D = var_0;
    var_0._id_4748 = 0;
    var_29 = ( 0, 90, 0 );
    var_27._id_5FA6 = "starting";
    level._id_9EA3 = var_27;
    var_0 _meth_8338( var_27._id_02E6 );
    ...
    var_30._id_1A13 = var_27;
    _id_4D20( var_27 );
    var_31 = 300;
    level._id_63BB = level._id_9E99;
    var_28 = 1000;
    var_32 = anglestoforward( var_27._id_0041 );
    var_33 = undefined;
    var_34 = undefined;
    var_35 = undefined;
    var_36 = undefined;
    ...
    for (;;)
    {
        ...
        if ( level._id_9EA2.size == 0 )
        {
            if ( var_30._id_5D32 == "game_lobby" || var_30._id_5D32 == "prelobby_loot" )
            {
                ...
                var_27._id_2569 = 1;
                var_0._id_117A = maps\mp\gametypes\vlobby::_id_40D0( 0 );
                _id_57E9( var_27, undefined, var_30, var_0._id_117A );
        ...
        else if ( var_37 )
        {
            ...
            var_37 = 0;
            var_27._id_02E6 = var_27._id_8D2D;
            var_27._id_0041 = var_27._id_8CF9;
            var_0 _meth_8131( 0 );
        }
        ...
        if ( !level._id_4C00 )
        {
            ...
            {
                var_0 _id_A75B::_id_6F0C( level._id_9EA2[level._id_9E99], level._id_9EA2[level._id_9E99]._id_0041 );
            ...
            if ( isdefined( level._id_9E97 ) || isdefined( level.prv_vl_clanprofile_focus ) )
            {
                ...
                {
                    level.prv_vl_clanprofile_focus = level._id_9E97;
                    var_0 _id_A75B::_id_6F0C( var_0.clan_agents[level._id_9E97], var_0.clan_agents[level._id_9E97]._id_0041 );
                }
            }
            ...
            if ( var_30._id_60B0 != var_30._id_5D32 )
            {
                ...
                if ( var_30._id_60B0 == "cac" )
                {
                    ...
                    var_10 = level._id_9EA2[level._id_9E99];
                    var_0 _id_A75B::_id_6F0C( var_10, var_10._id_0041 );
                }
                ...
                if ( var_30._id_60B0 == "cao" )
                {
                    if ( isdefined( level._id_9E9F ) && isdefined( level._id_9EA2[level._id_9E9F] ) )
                    {
                        ...
                        level._id_0328[0]._id_2236 = var_39._id_2236;
                        var_40 = level._id_0328[0] _id_A7B2::_id_6C7E();
                        var_40 = var_39 _id_A7B2::_id_6C7E();
                        var_41 = level._id_0328[0]._id_1B06;
                        _id_9E94( var_41, var_39._id_2236 );
                        var_40 = var_41 _id_A7B2::_id_6C7E();
                    ...
                    var_0 _id_A75B::_id_6F0C( var_0._id_1B06, var_0._id_1B06._id_0041 );
                    _id_8B53();
                    var_30._id_5D32 = var_30._id_60B0;
                    var_27._id_2569 = 1;
                    var_0 _meth_8338( var_10._id_02E6 );
                }
                else if ( var_30._id_60B0 == "clanprofile" )
                {
                    ...
                    for ( var_22 = 0; var_22 < 3; var_22++ )
                    {
                        ...
                        var_0 _id_A75B::_id_6F0C( var_0.clan_agents[var_22], var_0.clan_agents[var_22]._id_0041 );
                    }
                ...
                if ( var_30._id_60B0 == "game_lobby" )
                {
                    ...
                    if ( isdefined( level._id_9EA2 ) && isdefined( level._id_63BB ) && isdefined( level._id_9EA2[level._id_63BB] ) )
                        var_0 _id_A75B::_id_6F0C( level._id_9EA2[level._id_63BB], level._id_9EA2[level._id_63BB]._id_0041 );

                    var_30._id_01C1 = "waiting";
                    ...
                    if ( var_30._id_5D32 != "cac" )
                        var_27._id_2569 = 1;
                    else if ( var_30._id_5D32 == "cac" && isdefined( var_27._id_117A ) && var_27._id_117A != var_10._id_117A )
                        var_27._id_2569 = 1;

                    _id_8BF6();
                    var_27._id_5508 = var_10._id_117A;
                    var_27._id_117A = var_10._id_117A;
                    var_0 _id_A75B::_id_6F0C( var_10, var_10._id_0041 );
                    var_27._id_5FA6 = "starting";
                    var_0 _meth_8338( var_10._id_02E6 );
                }
            ...
            else if ( var_30._id_5D32 == "clanprofile" )
            {
                ...
                _id_57E9( var_27, level._id_9EA2[level._id_9E99], var_30, var_0._id_117A );
            ...
            else if ( var_30.caotolobbyframetimer <= 0 )
            {
                ...
                _id_57E9( var_27, var_10, var_30, var_0._id_117A );
                _id_9EA9( 1, "ac130_overlay_pip_vignette_vlobby" );
            }
            else
...
_id_8F0C( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        var_6 = getent( var_3._id_04A5, "targetname" );

        if ( var_6._id_039B == "camera_target" )
            var_3._id_1A18 = var_6;

        var_7 = getent( var_6._id_04A5, "targetname" );

        if ( var_7._id_039B == "camera" )
        {
...
_id_75F6( var_0, var_1 )
{
    if ( !isdefined( var_0 ) )
    {
        ...
        var_2._id_1A24 = ( 0, 87, 0 );
        return var_2;
    }

    var_3 = var_0 _meth_8180( "TAG_STOWED_BACK" );
    var_4 = var_0 _meth_8181( "TAG_STOWED_BACK" );
    var_5 = var_0._id_88CA[1] - var_0._id_0041[1];
    var_6 = ( 0, 0, 1 );
    var_7 = var_3 - var_0._id_02E6;
    var_8 = rotatepointaroundvector( var_6, var_7, var_5 );
    var_9 = var_0._id_02E6 + var_8;
...
_id_1CF6( var_0, var_1, var_2 )
{
    ...
    var_3 = distance( var_1, var_0._id_02E6 );
...
_id_57E9( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_1 ) )
    {
        ...
        if ( isdefined( var_3 ) )
            var_4 = ( 0, var_3._id_0041[1] + 180, 0 );

        var_5 = var_0._id_8D2D;
        var_6 = distance( var_0._id_02E6, var_5 );
    ...
    else
    {
        if ( level._id_1A3E._id_3A0D == level._id_1A3E._id_6EA8 )
            _id_A75B::_id_6F0C( var_1, var_1._id_0041 );

        var_4 = ( 0, 87, 0 );

        if ( isdefined( var_1._id_117A ) )
            var_4 = ( 0, var_1._id_117A._id_0041[1] + 180, 0 );

        var_8 = var_1 _meth_8180( "TAG_STOWED_BACK" );
        ...
        {
            var_9 = var_1._id_117A._id_02E6 + anglestoforward( var_1._id_117A._id_0041 ) * var_2.gamelobbygroup_camera_crouchdistance;
            var_10 = ( var_9[0], var_9[1], var_2.gamelobbygroup_camera_crouchz );
        }
        else if ( var_1.camera_state == "hunch" )
        {
            var_9 = var_1._id_117A._id_02E6 + anglestoforward( var_1._id_117A._id_0041 ) * var_2.gamelobbygroup_camera_hunchdistance;
            var_10 = ( var_9[0], var_9[1], var_2.gamelobbygroup_camera_hunchz );
        }
        else if ( var_1.camera_state == "stand" )
        {
            var_9 = var_1._id_117A._id_02E6 + anglestoforward( var_1._id_117A._id_0041 ) * var_2.gamelobbygroup_camera_normaldistance;
            var_10 = ( var_9[0], var_9[1], var_2.gamelobbygroup_camera_normalz );
        }
        else if ( var_1.camera_state == "zoom_high" )
        {
            var_9 = var_1._id_117A._id_02E6 + anglestoforward( var_1._id_117A._id_0041 ) * var_2.gamelobbygroup_camera_closedistance;
        ...
        var_12 = 0;
        var_13 = 0;
        var_6 = distance( var_0._id_02E6, var_10 );
        ...
        if ( isdefined( var_1._id_117A ) && isdefined( var_0._id_117A ) && var_1._id_117A != var_0._id_117A )
        {
            var_0._id_5576 = var_0._id_117A;
            var_0._id_117A = var_1._id_117A;
            var_2._id_01C1 = "finding_new_position";
            var_11 = 1;
            var_0._id_3794 = 0;
        }
        else if ( var_11 == 1 )
            var_2._id_01C1 = "moving";

        if ( var_2._id_01C1 == "waiting" )
        {
            if ( var_11 == 1 )
            {
                var_2._id_01C1 = "moving";
            ...
            var_0._id_5508 = var_1._id_117A;
        }

        if ( var_2._id_01C1 == "finding_new_position" )
        {
            if ( var_11 == 1 )
            {
                var_0._id_5576 = var_0._id_117A;
                ...
                {
                    var_20 = [];
                    var_20["center"] = var_19._id_117A._id_02E6;
                    var_20["radius"] = var_17;
                    var_0._id_632A[var_0._id_632A.size] = var_20;
                }

                _id_1860( var_0, var_2, var_0._id_02E6, var_10, var_4 );
        ...
        if ( var_2._id_01C1 == "moving" )
        {
            if ( level._id_1A3E._id_3A0D <= 0 )
            {
                ...
                if ( var_0._id_3794 )
                {
                    ...
                    var_2._id_01C1 = "waiting";
                }
            }
        }

        level._id_0328[0] _id_7DD5();
    }
...
_id_834B()
{
    ...
    if ( level._id_9EA2.size > 0 && isdefined( level._id_9EA2[0] ) && isdefined( level._id_9EA2[0]._id_0343 ) && isweaponloaded( level._id_9EA2[0]._id_0343 ) )
    {
...
_id_5F64( var_0 )
{
    var_1 = level._id_0328[0];
    var_2 = var_1 _meth_80A8();
    var_3 = var_2 - var_1._id_02E6;
    var_1 _meth_8338( var_0._id_02E6 - var_3, 0 );
    var_1 _meth_833A( ( var_1._id_0041[0], var_0._id_0041[1], var_1._id_0041[2] ) );
}
...
_id_3F05()
{
    ...
    var_0._id_0523 = _id_A75A::_id_8F54( var_3[0] );
    var_0._id_01E9 = _id_A75A::_id_8F54( var_3[1] );
    var_0._id_004C = _id_A75A::_id_764E( var_0._id_0523 / var_0._id_01E9, 3 );
    return var_0;
}
...
_id_1B1B( var_0, var_1, var_2 )
{
    ...
    var_3 = var_1._id_02E6 + ( 0, 0, -20 ) + anglestoforward( var_1._id_88CA ) * 120;
    var_2._id_A3F0 = var_2._id_1B07;
    var_2._id_2B6B = var_2._id_1B12 + ( var_2._id_1B0B - var_2._id_1B12 ) * var_2._id_A3F0;
    ...
    var_7 = var_1._id_02E6 + ( 0, 0, var_5 );
    var_8 = var_7 - var_3 + var_2._id_6592;
    var_8 = var_2._id_2B6B * vectornormalize( var_8 );
    ...
    var_12 = distance( var_0._id_02E6, var_9 );
...
_id_1E2C( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_1._id_117A ) )
        var_3 = ( 0, var_1._id_117A._id_0041[1] + 180, 0 );

    var_0 _id_9AA1( var_2 );
    var_4 = ( 14, 0, 0 );
    var_5 = var_1._id_02E6 + var_4 + anglestoforward( var_1._id_117A._id_0041 ) * 110;
    var_6 = ( var_5[0], var_5[1], var_2.gamelobbygroup_camera_normalz );
    var_0.goal_location = var_6;
    var_7 = distance( var_0._id_02E6, var_6 );
...
_id_5E18()
{
    ...
    for (;;)
    {
        ...
        if ( level._id_1A3E._id_5D32 != "cao" )
        {
            ...
            if ( _id_A4F0::_id_8F4F( level._id_1A3E._id_5D32, "prelobby" ) >= 0 && var_0 == 1 )
                level._id_1A3E._id_60B0 = "game_lobby";
        }
...
_id_9FD2( var_0, var_1 )
{
    ...
    for ( var_2 = self _meth_84EF( var_0._id_2236, var_0._id_04A8 ); !var_2; var_2 = self _meth_84EF( var_0._id_2236, var_0._id_04A8 ) )
        wait 0.1;
...
_id_88C8( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    var_15._id_117A = var_0;
    var_15._id_2236 = var_7;
    var_15._id_0015 = 0;
    var_15._id_760B = 0;
    var_15 _id_7DAC( var_13, var_14 );
    var_16 = getgroundposition( var_15._id_117A._id_02E6, 20, 512, 120 );
    var_15._id_88CA = ( var_0._id_0041[0], var_0._id_0041[1] + var_15._id_760B, var_0._id_0041[2] );
    var_15._id_0041 = var_15._id_88CA;

    if ( !var_11 )
        var_15 _meth_8053();

    var_15._id_6631 = var_9;
    var_15 _meth_833A( var_15._id_88CA );
    var_15 _meth_8338( var_16, 1 );
    var_15._id_0041 = var_15._id_88CA;
    var_15._id_8CF9 = var_15._id_88CA;
    var_15._id_8F14 = var_15._id_0041[1];
    var_15.mouserot = 0;
    var_15._id_8F15 = 0;
    var_15._id_760D = 0;
    var_15._id_0845 = 0;
    var_15._id_760C = spawn( "script_origin", var_15._id_02E6 );
    var_15._id_1A15 = 1;
    var_15._id_1A25 = ( 0, 0, 0 );
    var_15._id_1A24 = ( 0, 0, 0 );
    var_15 _meth_83FC();
    ...
    var_15 _id_A7AF::_id_0848();

    if ( isalive( var_15 ) )
    {
        _id_9E95( undefined, var_9, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_15 );

        if ( level._id_0328.size > 0 )
            level._id_0328[0] thread _id_9FD2( var_15, var_12 );
    }
...
_id_1D27( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( self ) && isdefined( self._id_0343 ) && isalive( self ) )
        {
            var_2 = strtok( self._id_0343, "_" );

            if ( ( issubstr( var_2[1], "dlcgun3" ) || var_2[1] == "dlcgun10loot5" || var_2[1] == "dlcgun5loot5" ) && _id_A4F0::_id_0CE4( var_2, "akimbo" ) )
        ...
        if ( isdefined( level._id_1A3E._id_5D32 ) )
        {
            if ( level._id_1A3E._id_60B0 != "cao" && level._id_1A3E._id_5D32 != "cao" )
            {
                ...
                {
                    var_9 = isweaponloaded( self._id_0343 );
                    var_10 = self._id_8F12 != self._id_0343;
                    var_11 = var_10 || var_3 != var_6;
                    var_12 = getweaponbasename( self._id_8F12 ) != getweaponbasename( self._id_0343 );
                    ...
                    if ( var_11 )
                    {
                        if ( var_9 )
                        {
                            ...
                            self._id_6F8C _meth_8483( self._id_0343 );
                            self._id_09AE _meth_8483( self._id_0343 );

                            if ( issubstr( self._id_0343, "akimbo" ) || issubstr( self._id_0343, "akimboxmg" ) )
                            {
                                if ( var_12 )
...
isweaponloaded( var_0 )
{
    ...
    if ( level._id_0328.size > 0 )
    {
        var_1 = level._id_0328[0] _meth_8535( var_0 );

        if ( !var_1 )
            level._id_0328[0] _meth_8511( var_0 );
    }
...
_id_9E9A( var_0, var_1 )
{
    ...
    if ( !isdefined( var_1._id_0343 ) )
        return;

    if ( !isdefined( var_1._id_0C4C ) )
        return;

    if ( var_1._id_0343 != "none" )
    {
        if ( !isdefined( var_1._id_6F8C ) )
        {
            var_2 = spawn( "weapon_" + var_1._id_0343, ( 0, 0, 0 ) );
            var_3 = get_xuid_for_avatar( var_1 );
            _func_2D4( var_2, var_3 );
            var_1._id_6F8C = var_2;
            var_2._id_0343 = var_1._id_0343;
            var_1._id_6F8C _meth_8053();
            var_1._id_6F8C _meth_804C();
            var_1._id_6F8C _meth_8483( var_1._id_0343 );
            attachprimaryweapon( var_1 );
        }
        else if ( var_1._id_6F8C._id_0343 != var_1._id_0343 )
            var_1._id_6F8C._id_0343 = var_1._id_0343;

        if ( !isdefined( var_1._id_09AE ) )
        {
            var_4 = spawn( "weapon_" + var_1._id_0343, ( 0, 0, 0 ) );
            var_3 = get_xuid_for_avatar( var_1 );
            _func_2D4( var_4, var_3 );
            var_1._id_09AE = var_4;
            var_4._id_0343 = var_1._id_0343;
        }
        else if ( var_1._id_09AE._id_0343 != var_1._id_0343 )
            var_1._id_09AE._id_0343 = var_1._id_0343;

        var_5 = "tag_weapon_left";

        if ( issubstr( var_1._id_09AE._id_0343, "combatknife" ) )
            var_5 = "tag_inhand";

        if ( issubstr( var_1._id_09AE._id_0343, "riotshield" ) )
            var_5 = "tag_weapon_left";

        var_1._id_09AE _meth_804F();
        var_1._id_09AE._id_02E6 = var_1 _meth_8180( var_5 );
        var_1._id_09AE._id_0041 = var_1 _meth_8181( var_5 );
        var_1._id_09AE _meth_8446( var_1, var_5 );
        var_1._id_09AE _meth_8530( var_0 );

        if ( issubstr( var_1._id_6F8C._id_0343, "akimbo" ) || issubstr( var_1._id_6F8C._id_0343, "akimboxmg" ) )
            thread _id_84F6( var_1 );
        else if ( !isdefined( var_1._id_8F12 ) )
        {
            var_1._id_09AE _meth_8054();
            var_1._id_09AE _meth_804A();
        }
    }

    if ( var_1._id_03B3 != "none" )
    {
        if ( issubstr( var_1._id_03B3, "combatknife" ) )
        {
            if ( isdefined( var_1._id_7BF7 ) )
            {
                if ( var_1._id_7BF7 _meth_8068() )
                    var_1._id_7BF7 _meth_804F();
        ...
        else
        {
            if ( !isdefined( var_1._id_7BF7 ) )
            {
                var_6 = spawn( "weapon_" + var_1._id_03B3, ( 0, 0, 0 ) );
                var_3 = get_xuid_for_avatar( var_1 );
                _func_2D4( var_6, var_3 );
                var_1._id_7BF7 = var_6;
                var_6._id_03B3 = var_1._id_03B3;
            }
            else if ( var_1._id_7BF7._id_03B3 != var_1._id_03B3 )
            {
                var_1._id_7BF7 _meth_8483( var_1._id_03B3 );
                var_1._id_7BF7._id_03B3 = var_1._id_03B3;
            }

            var_7 = "tag_stowed_back";
            var_1._id_7BF7 _meth_804F();
            var_1._id_7BF7._id_02E6 = var_1 _meth_8180( var_7 );
            var_1._id_7BF7._id_0041 = var_1 _meth_8181( var_7 );
            var_1._id_7BF7 _meth_8446( var_1, var_7 );
...
attachprimaryweapon( var_0 )
{
    ...
    if ( isdefined( var_0._id_031D ) )
        var_1 = var_0._id_031D;

    var_2 = "tag_weapon_right";

    if ( issubstr( var_0._id_6F8C._id_0343, "combatknife" ) )
        var_2 = "tag_inhand";

    if ( issubstr( var_0._id_6F8C._id_0343, "riotshield" ) )
        var_2 = "tag_weapon_left";

    var_0._id_6F8C _meth_804F();
    var_0._id_6F8C._id_02E6 = var_0 _meth_8180( var_2 );
    var_0._id_6F8C._id_0041 = var_0 _meth_8181( var_2 );
    var_0._id_6F8C _meth_8446( var_0, var_2 );
    var_0._id_6F8C _meth_8530( var_1 );
}

_id_07FA( var_0 )
{
    var_0 _meth_802A( "npc_exo_arm_launcher_R", "J_Elbow_RI", 0 );
    var_0 _meth_802A( "npc_exo_arm_launcher_L", "J_Elbow_LE", 0 );

    if ( isdefined( var_0._id_0253 ) && var_0._id_0253 != "specialty_null" )
    {
        if ( !var_0 _id_A75A::_id_05CB( "specialty_wildcard_dualtacticals" ) )
            var_0 _meth_801D( "npc_exo_arm_launcher_R", "J_Elbow_RI", 1 );
        else
        {
    ...
    {
        if ( var_0 _id_A75A::_id_05CB( "specialty_wildcard_duallethals" ) )
            var_0 _meth_801D( "npc_exo_arm_launcher_L", "J_Elbow_LE", 1 );
        else
        {
...
_id_84F6( var_0 )
{
    ...
    if ( level._id_1A3E._id_60B0 != "cao" && level._id_1A3E._id_5D32 != "cao" )
    {
        if ( issubstr( var_0._id_6F8C._id_0343, "akimbo" ) || issubstr( var_0._id_6F8C._id_0343, "akimboxmg" ) )
        {
            var_0._id_09AE _meth_8053();
...
_id_9E94( var_0, var_1, var_2 )
{
    var_0 _meth_8310();
    var_0 _meth_802B();
    var_0._id_477A = undefined;

    if ( isdefined( var_1 ) )
        var_0._id_2236 = var_1;

    if ( !isdefined( var_0._id_2236 ) || !_id_A7B2::_id_9C49( var_0._id_2236 ) )
    {
        if ( isdefined( var_0._id_7DA6 ) && _id_A7B2::_id_9C49( var_0._id_7DA6 ) )
            var_0._id_2236 = var_0._id_7DA6;
        else
        {
            var_0._id_2236 = _id_A7B2::_id_3F4D();
            var_0._id_7DA6 = var_0._id_2236;
        }
    }

    if ( isdefined( var_2 ) && var_2 )
    {
        level._id_0328[0]._id_2236 = var_0._id_2236;
        var_3 = level._id_0328[0] _id_A7B2::_id_6C7E();
        var_3 = var_0 _id_A7B2::_id_6C7E();
        var_4 = level._id_0328[0]._id_1B06;
        _id_9E94( var_4, var_0._id_2236 );
        var_3 = var_4 _id_A7B2::_id_6C7E();
    }
}
...
_id_9E95( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( isdefined( var_9._id_57D3 ) && var_9._id_57D3._id_031E >= 0 )
        var_10 = 1;

    _id_9E94( var_9, var_8 );
    var_9 _id_A7B2::_id_6D12( var_4, _id_A75A::_id_3F0F( var_3 ) );

    if ( var_10 && isdefined( level._id_0328[0] ) )
        level._id_0328[0] _meth_84BA( var_9._id_2236 );

    var_9._id_0343 = var_2;
    var_9._id_03B3 = "none";
    var_9._id_0428 = var_6;
    var_9._id_0253 = var_5;
    var_9._id_030B = var_7;
...
_id_5D68( var_0, var_1 )
{
    ...
    if ( var_1 != "current" && var_1 != "none" && var_2 == "" )
    {
        ...
        var_4 = _id_A781::_id_188C( var_1, var_3, "none", "none" );
    }
    else if ( var_1 == "none" )
        var_4 = "none";
    else
...
_id_5D79( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( var_10 > 0 && isdefined( var_3 ) )
        {
            ...
            var_12 = var_11._id_57D3;
            var_13 = tablelookup( "mp/statstable.csv", 0, var_12._id_033B, 4 );
            var_14 = tablelookup( "mp/attachmenttable.csv", 0, var_12._id_033C, 3 );
            var_15 = tablelookup( "mp/attachmenttable.csv", 0, var_12._id_033D, 3 );
            var_16 = tablelookup( "mp/attachmenttable.csv", 0, var_12._id_033E, 3 );
            var_17 = var_12._id_0340;
            ...
            level._id_1999 = _id_A781::_id_188C( var_13, var_14, var_15, var_16, var_17, undefined );
        }
    }
}
...
_id_3F9C( var_0 )
{
    ...
    {
        if ( isdefined( var_2._id_57D3 ) && isdefined( var_2._id_57D3._id_031E ) && var_2._id_57D3._id_031E == var_0 )
            return var_3;
    }
...
{
    if ( isdefined( self._id_030D["class"] ) && self._id_030D["class"] == var_1 && ( !isdefined( var_3 ) || !var_3 ) )
        return;
    ...
    _id_A781::_id_41DD( self._id_030D["team"], self._id_030D["class"] );

    if ( var_2 )
    {
        _id_9E95( self, var_0, self._id_0343, self._id_03B3, self._id_030D["primaryWeapon"], self._id_57D8, self._id_57DA, self._id_030B, self._id_2236 );

        if ( isdefined( self._id_1B06 ) )
            _id_9E95( self, var_0, undefined, self._id_03B3, self._id_030D["primaryWeapon"], self._id_57D8, self._id_57DA, self._id_030B, self._id_2236, self._id_1B06 );
    }
}
...
_id_42ED()
{
    ...
    foreach ( var_4 in var_0 )
    {
        ...
        {
            var_7 = [];
            var_7["primary"] = _id_A781::_id_1985( var_6, 0 );
            var_7["primaryAttachment1"] = _id_A781::_id_1986( var_6, 0 );
            var_7["primaryAttachment2"] = _id_A781::_id_1988( var_6, 0 );
            var_7["primaryAttachment3"] = _id_A781::_id_1987( var_6, 0 );
            var_7["primaryCamo"] = _id_A781::_id_1989( var_6, 0 );
            var_7["primaryReticle"] = _id_A781::_id_198A( var_6, 0 );

            for ( var_8 = 0; var_8 < 6; var_8++ )
                var_7["perk" + var_8] = _id_A781::_id_1984( var_6, var_8 );

            for ( var_8 = 0; var_8 < 3; var_8++ )
                var_7["wildcard" + var_8] = _id_A781::_id_198B( var_6, var_8 );

            var_7["secondary"] = _id_A781::_id_1985( var_6, 1 );
            var_7["secondaryAttachment1"] = _id_A781::_id_1986( var_6, 1 );
            var_7["secondaryAttachment2"] = _id_A781::_id_1988( var_6, 1 );
            var_7["secondaryAttachment3"] = _id_A781::_id_1987( var_6, 1 );
            var_7["secondaryCamo"] = _id_A781::_id_1989( var_6, 1 );
            var_7["secondaryReticle"] = _id_A781::_id_198A( var_6, 1 );
            var_7["equipment"] = _id_A781::_id_197F( var_6, 0 );
            var_7["offhand"] = _id_A781::_id_197F( var_6, 1 );
            self._id_0257[var_4][var_6] = var_7;
        }
    }

    level._id_39AF = undefined;
}
...
_id_9ABC( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15, var_16, var_17, var_18, var_19, var_20, var_21 )
{
    ...
    var_23 = _id_A75A::_id_197E();
    self._id_0257[var_23][var_22]["primary"] = var_0;
    self._id_0257[var_23][var_22]["primaryAttachment1"] = var_1;
    self._id_0257[var_23][var_22]["primaryAttachment2"] = var_2;
    self._id_0257[var_23][var_22]["primaryAttachment3"] = var_3;
    self._id_0257[var_23][var_22]["primaryCamo"] = var_4;
    self._id_0257[var_23][var_22]["primaryReticle"] = var_5;
    self._id_0257[var_23][var_22]["secondary"] = var_6;
    self._id_0257[var_23][var_22]["secondaryAttachment1"] = var_7;
    self._id_0257[var_23][var_22]["secondaryAttachment2"] = var_8;
    self._id_0257[var_23][var_22]["secondaryCamo"] = var_9;
    self._id_0257[var_23][var_22]["secondaryReticle"] = var_10;
    self._id_0257[var_23][var_22]["equipment"] = var_11;
    self._id_0257[var_23][var_22]["lethal"] = var_11;
    self._id_0257[var_23][var_22]["offhand"] = var_12;
    self._id_0257[var_23][var_22]["tactical"] = var_12;
    self._id_0257[var_23][var_22]["wildcard0"] = var_13;
    self._id_0257[var_23][var_22]["wildcard1"] = var_14;
    self._id_0257[var_23][var_22]["wildcard2"] = var_15;
    self._id_0257[var_23][var_22]["perk0"] = var_16;
    self._id_0257[var_23][var_22]["perk1"] = var_17;
    self._id_0257[var_23][var_22]["perk2"] = var_18;
    self._id_0257[var_23][var_22]["perk3"] = var_19;
    self._id_0257[var_23][var_22]["perk4"] = var_20;
    self._id_0257[var_23][var_22]["perk5"] = var_21;
}
...
_id_57D4( var_0, var_1 )
{
    ...
    if ( var_0._id_033E != var_1._id_033E )
        return 1;

    if ( var_0._id_0340 != var_1._id_0340 )
        return 1;

    if ( var_0._id_03AC != var_1._id_03AC )
        return 1;

    if ( var_0._id_03AD != var_1._id_03AD )
        return 1;

    if ( var_0._id_03AE != var_1._id_03AE )
        return 1;

    if ( var_0._id_03B0 != var_1._id_03B0 )
        return 1;
...
_id_5DB8()
{
    ...
    for (;;)
    {
        while ( !isdefined( level._id_0328 ) || level._id_0328.size == 0 || !isdefined( level._id_1A3E ) )
            wait 0.05;

        while ( isdefined( level._id_0328 ) && level._id_0328.size > 0 )
        {
            foreach ( var_1 in level._id_5A76 )
            {
                var_2 = tablelookup( "mp/statstable.csv", 0, var_1._id_033B, 4 );
                var_3 = tablelookup( "mp/attachmenttable.csv", 0, var_1._id_033C, 3 );
                var_4 = tablelookup( "mp/attachmenttable.csv", 0, var_1._id_033D, 3 );
                var_5 = tablelookup( "mp/attachmenttable.csv", 0, var_1._id_033E, 3 );
                var_6 = var_1._id_0340;
                var_7 = tablelookup( "mp/camoTable.csv", 0, var_1._id_0340, 1 );
                var_8 = var_1._id_0342;
                var_9 = tablelookup( "mp/reticleTable.csv", 0, var_1._id_0342, 1 );
                var_10 = tablelookup( "mp/statstable.csv", 0, var_1._id_03AC, 4 );
                var_11 = tablelookup( "mp/attachmenttable.csv", 0, var_1._id_03AD, 3 );
                var_12 = tablelookup( "mp/attachmenttable.csv", 0, var_1._id_03AE, 3 );
                var_13 = "none";
                var_14 = var_1._id_03B0;
                var_15 = tablelookup( "mp/camoTable.csv", 0, var_1._id_03B0, 1 );
                var_16 = var_1._id_03B2;
                var_17 = tablelookup( "mp/reticleTable.csv", 0, var_1._id_03B2, 1 );
                ...
                var_29 = _id_A781::_id_188C( var_2, var_3, var_4, var_5, var_6, var_8 );
                var_30 = _id_A781::_id_188C( var_10, var_11, var_12, var_13, var_14, var_16 );
                var_31 = _id_A75A::_id_3F0F( var_29 );
                var_32 = [];
                ...
                if ( !isdefined( level._id_A3A7[var_1._id_0537] ) && _id_A75B::_id_09DF() )
                    _id_A75B::_id_74E0( var_1._id_0537 );

                if ( !isdefined( level._id_A3A7[var_1._id_0537] ) )
                {
                    var_34 = _id_A75B::_id_0735( var_1._id_0537 );
                    _id_A75B::vlprint( "PartyMemberClassChange " + var_1._id_0537 + " : " + var_29 + "," + var_30 + "," + var_18 + "," + var_19 + "\\n" );
                    setdvar( "virtuallobbymembers", level._id_A3A7.size );
                    var_35 = maps\mp\gametypes\vlobby::_id_40D0( var_34 );
                    _id_88C8( var_35, var_29, var_30, var_31, var_18, var_19, var_33, var_32, var_1._id_02AB, var_34, 0 );
                    _id_A75B::_id_1178( var_34 );
                    _func_2D4( level._id_9EA2[var_34], var_1._id_0537 );
                    level._id_9EA2[var_34]._id_57D3 = var_1;
                    level._id_9EA2[var_34]._id_5BA4 = gettime() + 4000;

                    if ( level._id_9EA2.size == 1 )
                    {
                        var_36 = level._id_0328[0]._id_1B06;
                        _id_9E94( var_36, level._id_9EA2[var_34]._id_2236 );
                        var_37 = var_36 _id_A7B2::_id_6C7E();
                    }
                ...
                var_34 = level._id_A3A7[var_1._id_0537];
                var_38 = level._id_9EA2[var_34];

                if ( var_1._id_031E >= 0 )
                {
                    if ( level._id_9E9F == var_34 )
                        level._id_0328[0] _id_9ABC( var_2, var_3, var_4, var_5, var_7, var_9, var_10, var_11, var_12, var_15, var_17, var_18, var_19, var_20, var_21, var_22, var_23, var_24, var_25, var_26, var_27, var_28 );
                    ...
                    if ( isdefined( var_38._id_6F51 ) )
                    {
                        if ( isdefined( var_38._id_00D8 ) && isdefined( var_38._id_00D8[var_38._id_6F51] ) )
                            ...
                            var_32 = level._id_0328[0] _id_A781::_id_1B0E( var_38._id_6F51 );
                ...
                if ( _id_57D4( var_38._id_57D3, var_1 ) || _id_2237( var_38._id_2236, var_32 ) || isdefined( level._id_39AB ) && level._id_39AB )
                {
                    _id_A75B::vlprint( "Updating xuid " + var_1._id_0537 + " with ownerId=" + var_34 + "\\n" );
                    _id_A75B::vlprint( "PartyMemberClassChange " + var_1._id_0537 + " : " + var_29 + "," + var_30 + "," + var_18 + "," + var_19 + "\\n" );

                    if ( isdefined( var_38._id_031D ) )
                        var_38._id_031D._id_2236 = var_32;

                    _id_9E95( var_38._id_031D, var_34, var_29, var_30, var_31, var_18, var_19, var_33, var_32 );

                    if ( var_1._id_031E >= 0 )
                        _id_9E95( var_38._id_031D, var_34, undefined, var_30, var_31, var_18, var_19, var_33, var_32, level._id_0328[0]._id_1B06 );

                    var_38._id_57D3 = var_1;
                    level._id_39AB = 0;
                }
            }
...
vl_vfx_for_avatar()
{
    ...
    {
        _id_A781::checkforcostumeset();

        if ( isdefined( self.costumebonus ) && isdefined( self.costumebonus["xp"] ) )
        {
            self.set_bonus_vfx = 1;

            if ( !isdefined( self.camera_state ) || self.camera_state != "crouch" || self == level._id_0328[0]._id_1B06 )
            {
                if ( !isdefined( self.spawned_vfx_setbonus_stand ) || _func_294( self.spawned_vfx_setbonus_stand ) )
                {
                    ...
                    self.spawned_vfx_setbonus_stand = spawnfx( level.vfx_setbonus_stand_01, self._id_02E6 );
            ...
            else if ( !isdefined( self.spawned_vfx_setbonus_crouch ) || _func_294( self.spawned_vfx_setbonus_crouch ) )
            {
                ...
                self.spawned_vfx_setbonus_crouch = spawnfx( level.vfx_setbonus_crouch_01, self._id_02E6 );
...
_id_661E( var_0 )
{
    ...
    {
        var_1 = _func_296( level._id_6E94 ) - 1;
        level.practice_round_class = randomint( var_1 );
    }

    var_4 = var_0;
    var_5 = _func_2CF( level._id_6E95, level.practice_round_costume + 1 );
    ...
    var_7 = var_6 + 1;
    var_8 = tablelookup( level._id_6E94, 0, "loadoutPrimary", var_7 );
    var_9 = tablelookup( level._id_6E94, 0, "loadoutPrimaryAttachment", var_7 );
    var_10 = tablelookup( level._id_6E94, 0, "loadoutPrimaryAttachment2", var_7 );
    var_11 = tablelookup( level._id_6E94, 0, "loadoutPrimaryAttachment3", var_7 );
    var_12 = tablelookup( level._id_6E94, 0, "loadoutPrimaryCamo", var_7 );
    var_13 = tablelookup( level._id_6E94, 0, "loadoutPrimaryReticle", var_7 );
    var_4._id_033B = int( tablelookup( "mp/statstable.csv", 4, var_8, 0 ) );
    var_4._id_033C = int( tablelookup( "mp/attachmenttable.csv", 3, var_9, 0 ) );
    var_4._id_033D = int( tablelookup( "mp/attachmenttable.csv", 3, var_10, 0 ) );
    var_4._id_033E = int( tablelookup( "mp/attachmenttable.csv", 3, var_11, 0 ) );
    var_4._id_0340 = int( tablelookup( "mp/camoTable.csv", 1, var_12, 0 ) );
    var_4._id_0342 = int( tablelookup( "mp/reticleTable.csv", 1, var_13, 0 ) );
    var_14 = tablelookup( level._id_6E94, 0, "loadoutSecondary", var_7 );
    var_15 = tablelookup( level._id_6E94, 0, "loadoutSecondaryAttachment", var_7 );
    var_16 = tablelookup( level._id_6E94, 0, "loadoutSecondaryAttachment2", var_7 );
    var_17 = tablelookup( level._id_6E94, 0, "loadoutSecondaryCamo", var_7 );
    var_18 = tablelookup( level._id_6E94, 0, "loadoutSecondaryReticle", var_7 );
    var_4._id_03AC = int( tablelookup( "mp/statstable.csv", 4, var_14, 0 ) );
    var_4._id_03AD = int( tablelookup( "mp/attachmenttable.csv", 3, var_15, 0 ) );
    var_4._id_03AE = int( tablelookup( "mp/attachmenttable.csv", 3, var_16, 0 ) );
    var_4._id_03B0 = int( tablelookup( "mp/camoTable.csv", 1, var_17, 0 ) );
    var_4._id_03B2 = int( tablelookup( "mp/reticleTable.csv", 1, var_18, 0 ) );
    var_19 = tablelookup( level._id_6E94, 0, "loadoutWildcard1", var_7 );
    var_20 = tablelookup( level._id_6E94, 0, "loadoutWildcard2", var_7 );
    var_21 = tablelookup( level._id_6E94, 0, "loadoutWildcard3", var_7 );
...
_id_0782( var_0 )
{
    ...
    {
        if ( level._id_5A76[var_1]._id_0537 == var_0._id_0537 )
        {
...
_id_5D7A( var_0 )
{
    ...
    for (;;)
    {
            ...
            if ( isdefined( var_3 ) )
            {
                ...
                if ( isdefined( var_3._id_00D8 ) && isdefined( var_3._id_00D8[var_3._id_6F51] ) )
                {
                    ...
                    if ( var_3._id_6F51 == var_3._id_0015 )
                        var_3 _meth_84BA( var_3._id_00D8[var_3._id_6F51] );
                }
            }
        ...
        if ( var_1 == "costume_set_apply" )
        {
            ...
            {
                var_8 = level._id_0328[0] _id_A781::_id_1B0E( var_7 );
            ...
            var_3 _meth_84BA( var_3._id_00D8[var_7] );
        }
    }
}
...
clans_set_highlight_gear_from_lua( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        {
            var_5 = int( var_4[0] );
            var_6 = level._id_0328[0].clan_agents[var_5];
...
_id_84B9( var_0 )
{
    ...
    {
        var_0._id_7BF7 _meth_8053();
        var_0._id_7BF7 _meth_804C();
    }

    if ( isdefined( var_0._id_09AE ) && isdefined( var_0._id_09AE._id_0343 ) )
    {
        if ( issubstr( var_0._id_09AE._id_0343, "akimbo" ) || issubstr( var_0._id_09AE._id_0343, "akimboxmg" ) )
        {
            var_0._id_09AE _meth_8053();
            var_0._id_09AE _meth_804C();
        }
...
_id_732F( var_0 )
{
    ...
    _func_2D4( level._id_9EA2[var_0], var_3, 1 );
    ...
    var_4 _meth_8310();
    var_4 _meth_802B();
    var_4._id_477A = undefined;
    var_4 _meth_804A();

    if ( isdefined( var_4._id_117A._id_8999 ) )
        var_4._id_117A._id_8999 = undefined;

    if ( isdefined( var_4._id_6F8C ) )
    {
        _func_2D4( var_4._id_6F8C, var_3, 1 );
    ...
    {
        _func_2D4( var_4._id_7BF7, var_3, 1 );
    ...
    {
        _func_2D4( var_4._id_09AE, var_3, 1 );
        var_4._id_09AE delete();
        var_4._id_09AE = undefined;
    }

    var_4._id_0343 = undefined;
...
_id_8C45()
{
    ...
    foreach ( var_1 in level._id_9EA2 )
    {
        ...
        {
            var_2 = var_1 _id_3EF9( var_1._id_0343 );
...
{
    var_5 = _id_3752( var_0._id_02E6, var_3, var_0._id_632A );
    var_0._id_66BA = var_5;
    var_6 = 0;

    foreach ( var_9, var_8 in var_0._id_66BA )
    {
        if ( var_9 > 0 )
            var_6 += distance( var_0._id_66BA[var_9], var_0._id_66BA[var_9 - 1] );
    }

    var_0._id_66E5 = 0;
    var_0._id_66E6 = var_0._id_66C5;
    var_0._id_66DF = var_6;
    var_0._id_66E2 = anglestoforward( var_0._id_0041 );
    var_0._id_66DC = anglestoforward( var_4 );
    var_0._id_66E3 = angleclamp180( var_0._id_0041[0] );
    var_0._id_66DA = var_0._id_66E3;
    var_0._id_66DD = angleclamp180( var_4[0] );
    var_0._id_66E4 = angleclamp180( var_0._id_0041[1] );
    var_0._id_66DE = angleclamp180( var_4[1] );
    var_0._id_66E1 = var_2;
    var_0._id_66DB = var_3;
    var_0._id_66E7 = ( 0, 0, 0 );
...
_id_56AA( var_0, var_1 )
{
    ...
    var_3 = angleclamp180( var_0._id_0041[0] );
    var_4 = angleclamp180( var_1[1] - var_0._id_0041[1] );
...
_id_9AA2( var_0 )
{
    ...
    while ( var_2 > 0 )
    {
        var_3 = distance( var_0._id_66BA[var_0._id_66D9], var_0._id_66BA[var_0._id_66D9 + 1] );
        var_4 = var_3 - var_0._id_2B7F;

        if ( var_4 > var_2 )
        {
            var_0._id_2B7F += var_2;
            var_5 = var_0._id_66BA[var_0._id_66D9] + var_0._id_2B7F * vectornormalize( var_0._id_66BA[var_0._id_66D9 + 1] - var_0._id_66BA[var_0._id_66D9] );
            var_0._id_66E7 = var_5 - var_0._id_02E6;
        ...
        if ( var_0._id_66D9 >= var_0._id_66BA.size - 1 )
        {
            if ( var_0._id_66D9 < var_0._id_66BA.size )
                var_5 = var_0._id_66BA[var_0._id_66D9];
            else
                var_5 = var_0._id_66BA[var_0._id_66BA.size - 1];
...
{
    var_1 = var_0._id_02E6;
    var_2 = var_0._id_1A17._id_02E6;
    var_3 = var_0._id_1A18._id_02E6;
...
_id_268B( var_0 )
{
    ...
    while ( !_id_9AA0( var_0 ) )
    {
        ...
        var_5 = _id_19BB( var_0._id_3A03, var_0._id_02E6, var_4 );
        var_2--;
    ...
    var_0._id_0041 = ( angleclamp180( var_0._id_0041[0] ), angleclamp180( var_0._id_0041[1] ), angleclamp180( var_0._id_0041[2] ) );
    var_0 _meth_8092();
}
...
_id_92A2( var_0, var_1, var_2, var_3 )
{
    ...
    var_12 = var_11 + anglestoforward( var_0._id_0041 ) * 64;
    var_13 = var_9 + anglestoforward( var_10 ) * 64;
    var_0._id_02E6 = var_11;
    var_0._id_0041 = var_10;
    var_0._id_632A = var_3;
    _id_4D20( var_0 );
    _id_1860( var_0, undefined, var_0._id_02E6, var_9, var_10 );
...
_id_26B2()
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        if ( var_4._id_039B == "camera_target" )
            var_3._id_1A18 = var_4;

        var_5 = getent( var_4._id_04A5, "targetname" );

        if ( var_5._id_039B == "camera" )
        {
    ...
    for (;;)
    {
        ...
        if ( var_0 )
        {
            ...
            foreach ( var_18, var_16 in var_1 )
            {
                ...
                var_17 = [];
                var_17["center"] = var_16._id_02E6;
                var_17["radius"] = var_11;
                var_12[var_12.size] = var_17;

                if ( var_16._id_039B == "" + var_8 )
                    var_13 = var_16;

                if ( var_16._id_039B == "" + var_9 )
                    var_14 = var_16;
            }
...
_id_2698( var_0 )
{
    ...
    var_0._id_02E6 = var_0._id_02E6 + var_5[0] * var_1 * var_6 + var_5[1] * var_2 * var_8 + var_9 * var_3 * var_7;
}
...
_id_9EA9( var_0, var_1 )
{
    if ( !isdefined( self._id_9C6B ) )
    {
        ...
        self._id_9C6B._id_0530 = 0;
        self._id_9C6B._id_0538 = 0;
        self._id_9C6B _meth_80CC( var_1, 640, 480 );
        self._id_9C6B._id_002C = "left";
        self._id_9C6B._id_002D = "top";
        self._id_9C6B._id_01F4 = "fullscreen";
        self._id_9C6B._id_0500 = "fullscreen";
        self._id_9C6B._id_0037 = var_0;
    }

    if ( isdefined( self._id_9C6B ) && self._id_9C6B._id_0037 > 0 && var_0 == 0 )
    {
        self._id_9C6B _meth_80CC( var_1, 640, 480 );
        self._id_9C6B._id_0037 = 0;
    }

    if ( isdefined( self._id_9C6B ) && self._id_9C6B._id_0037 < 1 && var_0 == 1 )
    {
        self._id_9C6B _meth_80CC( var_1, 640, 480 );
        self._id_9C6B._id_0037 = 1;
    }
}
