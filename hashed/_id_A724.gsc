...
_id_8740( var_0, var_1 )
{
    ...
    if ( level._id_91E4 )
    {
        ...
        {
            if ( isdefined( var_3 ) && issentient( var_3 ) && issentient( self ) && var_3._id_04A8 != self._id_04A8 )
            {
                if ( soundexists( var_1 ) )
                    var_3 _meth_82F4( var_1 );
...
_id_8778( var_0, var_1, var_2 )
{
    ...
    var_5[0] = spawn( "script_origin", var_3._id_02E6 );
    var_5[0] _meth_8446( var_3 );
    var_5[0] _meth_8075( var_0 );
    var_5[1] = spawn( "script_origin", var_3._id_02E6 );
    var_5[1] _meth_8446( var_3 );
    var_5[1] _meth_8075( var_1 );
    var_5[2] = spawn( "script_origin", var_3._id_02E6 );
...
_id_8732( var_0, var_1, var_2, var_3 )
{
...
_id_8734( var_0, var_1, var_2 )
{
    var_3 = spawn( "script_origin", var_1._id_02E6 );
