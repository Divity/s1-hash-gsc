...
_id_303A( var_0 )
{
    ...
    for (;;)
    {
        if ( self._id_3385 == "[A]" )
        {
            ...
            for (;;)
            {
                ...
                if ( isdefined( var_3 ) && isplayer( var_3 ) && isalive( var_3 ) )
                {
                    ...
                    var_5 = isdefined( var_2._id_5EF1 ) && var_3 _meth_80A9( var_2._id_5EF1 );
                    var_6 = var_4 || var_5;
        ...
        if ( self._id_3385 == "[B]" )
        {
            ...
            _id_A4F0::_id_A060( "closed_inner_doors", "interrupted" );
...
_id_5D69()
{
    for (;;)
    {
        ...
        if ( var_6 )
            self _meth_809A( "elev_bell_ding" );
    }
}
...
_id_3D71( var_0 )
{
    ...
    var_0 _meth_82FC( "player_current_floor", _id_3D1D() );
...
_id_579C( var_0 )
{
    for (;;)
    {
        ...
        {
            var_1 _meth_809A( "elev_run_start" );
            var_1 _meth_8075( "elev_run_loop" );
        }

        if ( var_0 == "interrupted" )
            var_1 _meth_809A( "elev_door_interupt" );

        if ( var_0 == "elevator_moved" )
        {
            var_1 _meth_80AB( "elev_run_loop" );
            var_1 _meth_809A( "elev_run_end" );
            var_1 _meth_809A( "elev_bell_ding" );
        }
    }
}
...
_id_3042( var_0 )
{
    ...
    self endon( "elevator_moving" );
    var_1 = _id_3D9A();
    var_2 = self._id_2FF3["floor" + var_0 + "_pos"] - var_1._id_02E6;
    var_3 = level._id_3051;
    var_4 = abs( distance( self._id_2FF3["floor" + var_0 + "_pos"], var_1._id_02E6 ) );
    var_5 = var_4 / var_3;
    var_1 _meth_82AE( var_1._id_02E6 + var_2, var_5, var_5 * level._id_3029, var_5 * level._id_3036 );

    foreach ( var_7 in _id_3D94() )
    {
        var_8 = var_7._id_02E6 + var_2;

        if ( !issubstr( var_7._id_00AB, "trigger_" ) )
        {
            var_7 _meth_82AE( var_8, var_5, var_5 * level._id_3029, var_5 * level._id_3036 );
            continue;
        }

        var_7._id_02E6 = var_8;
    }
...
_id_1FD0()
{
    ...
    var_2 = _id_3D9A();
    var_3 = _id_3D95();
    var_4 = ( var_3[0], var_3[1], var_2._id_02E6[2] );
    var_5 = level._id_303D;
    var_6 = abs( distance( var_0._id_02E6, var_4 ) );
    var_7 = var_6 / var_5;
...
_id_6510()
{
    ...
    var_3 = _id_3D99();
    var_4 = _id_3D9F();
    var_5 = ( var_3[0], var_3[1], var_2._id_02E6[2] );
    var_6 = ( var_4[0], var_4[1], var_2._id_02E6[2] );
...
_id_184A()
{
    ...
    foreach ( var_4 in var_0 )
    {
        ...
        var_6 = [];
        var_6[0] = min( var_4._id_02E6[0], var_5._id_02E6[0] );
        var_6[1] = max( var_4._id_02E6[0], var_5._id_02E6[0] );
        var_6[2] = min( var_4._id_02E6[1], var_5._id_02E6[1] );
        var_6[3] = max( var_4._id_02E6[1], var_5._id_02E6[1] );
        var_7 = spawnstruct();
        ...
        foreach ( var_9 in var_1 )
        {
            if ( var_9 _id_511E( var_6 ) )
            {
                ...
                if ( var_9._id_00AB == "script_model" )
                    continue;

                if ( var_9._id_00AD == "light" )
                    continue;

                var_10 = getent( var_9._id_04A5, "targetname" );
                var_7._id_2FF3["housing"]["left_door"] = var_10;
                var_7._id_2FF3["housing"]["left_door_opened_pos"] = var_10._id_02E6;
                var_11 = getent( var_10._id_04A5, "targetname" );
                var_7._id_2FF3["housing"]["right_door"] = var_11;
                var_7._id_2FF3["housing"]["right_door_opened_pos"] = var_11._id_02E6;
                var_12 = ( var_10._id_02E6 - var_11._id_02E6 ) * ( 0.5, 0.5, 0.5 ) + var_11._id_02E6;
                var_7._id_2FF3["housing"]["door_closed_pos"] = var_12;
                var_13 = getent( var_11._id_04A5, "targetname" );
                var_7._id_2FF3["housing"]["door_trigger"] = var_13;
                var_14 = getent( var_13._id_04A5, "targetname" );
                var_7._id_2FF3["housing"]["inside_trigger"] = var_14;
                var_14 _id_5914();
                var_14._id_5EF1 = spawn( "trigger_radius", var_9._id_02E6, 0, 64, 128 );
            }
        }
        ...
        foreach ( var_17 in var_2 )
        {
            if ( var_17 _id_511E( var_6 ) )
            {
                ...
                var_7._id_2FF3["outer_doorset"][var_19]["door_closed_pos"] = var_17._id_02E6;
                var_20 = getent( var_17._id_04A5, "targetname" );
                var_7._id_2FF3["outer_doorset"][var_19]["left_door"] = var_20;
                var_7._id_2FF3["outer_doorset"][var_19]["left_door_opened_pos"] = var_20._id_02E6;
                var_21 = getent( var_20._id_04A5, "targetname" );
                var_7._id_2FF3["outer_doorset"][var_19]["right_door"] = var_21;
                var_7._id_2FF3["outer_doorset"][var_19]["right_door_opened_pos"] = var_21._id_02E6;

                if ( var_18 )
                {
                    var_22 = var_17._id_02E6 - var_20._id_02E6;
                    var_17._id_02E6 = var_20._id_02E6;
                    var_20._id_02E6 += var_22;
                    var_21._id_02E6 -= var_22;
                    var_7._id_2FF3["outer_doorset"][var_19]["door_closed_pos"] = var_17._id_02E6;
                    var_7._id_2FF3["outer_doorset"][var_19]["left_door_opened_pos"] = var_20._id_02E6;
                    var_7._id_2FF3["outer_doorset"][var_19]["right_door_opened_pos"] = var_21._id_02E6;
                }
        ...
        foreach ( var_24, var_33 in var_7._id_2FF3["outer_doorset"] )
        {
            ...
            var_31 = ( var_34._id_02E6[0], var_34._id_02E6[1], var_33["door_closed_pos"][2] );
            var_7._id_2FF3["floor" + var_24 + "_pos"] = var_31;

            if ( var_34._id_02E6 == var_31 )
            {
...
_id_183D()
{
    ...
    {
        var_1._id_2FF3 = [];
        var_2 = ( 0, 0, var_1._id_02E6[2] );
        var_3 = ( var_1._id_02E6[0], var_1._id_02E6[1], 0 );
        var_4 = [];
        ...
        var_1 _id_5914();
        var_1._id_5EF1 = spawn( "trigger_radius", var_1._id_02E6 + ( 0, 0, -32 ), 0, 32, 64 );
    }
}
...
_id_30FE()
{
    if ( !self._id_310C )
    {
        ...
        if ( isdefined( self._id_5EF1 ) )
            self._id_5EF1._id_02E6 += ( 0, 0, 10000 );
    }
}
...
_id_3D9A()
{
    ...
    {
        if ( var_3._id_00AB != "script_model" && var_3._id_00AD != "light" )
            var_1 = var_3;
    }
...
_id_3D9B()
{
    ...
    foreach ( var_3 in var_0 )
    {
        if ( var_3._id_00AB == "script_model" )
...
_id_511E( var_0 )
{
    var_1 = self._id_02E6[0];
    var_2 = self._id_02E6[1];
    var_3 = var_0[0];
    var_4 = var_0[1];
    var_5 = var_0[2];
    var_6 = var_0[3];
    ...
    for (;;)
    {
        ...
        foreach ( var_9 in level._id_3033 )
        {
            foreach ( var_16, var_5 in var_9._id_2FF3 )
            {
                ...
                {
                    var_11++;
                    var_14 = var_9._id_02E6 + ( 0, 0, var_11 * -4 );
                }
            }
        }
