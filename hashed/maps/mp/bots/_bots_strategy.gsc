...
_id_15ED()
{
    ...
    if ( isdefined( var_0 ) && var_0.size > 0 )
        return _id_A4F0::_id_710B( var_0 )._id_02E6;
...
_id_16E8( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( !isdefined( var_4 ) && isdefined( var_1 ) && var_1.size > 0 )
    {
        ...
        foreach ( var_9 in var_1 )
        {
            ...
            if ( distancesquared( var_9._id_02E6, var_2._id_02E6 ) > 90000 )
            {
                if ( vectordot( var_7, vectornormalize( var_9._id_02E6 - var_2._id_02E6 ) ) < 0.4 )
                    var_6[var_6.size] = var_9;
            }
        }
        ...
        if ( var_6.size > 0 )
        {
            var_5 = _id_A4F0::_id_710B( var_6 );
            var_11 = getnodesinradius( var_5._id_02E6, 300, 50 );
            var_12 = [];
    ...
    if ( isdefined( var_4 ) )
    {
        ...
        {
            var_17 = vectortoangles( var_5._id_02E6 - var_4._id_02E6 );
            var_16 = var_17[1];
        }
        ...
        if ( var_18 )
        {
            ...
            if ( var_19 == "goal" )
            {
                ...
                {
                    if ( isdefined( var_16 ) )
                        self _meth_8367( var_5._id_02E6, var_0["item_action"] );
                    else
                        self _meth_8367( self._id_02E6 + anglestoforward( self._id_0041 ) * 50, var_0["item_action"] );
                    ...
                    _id_A4F0::_id_A06A( var_20, "missile_fire", "grenade_fire" );
                    wait 0.05;
...
_id_1734( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        if ( distancesquared( self._id_02E6, var_0._id_02E6 ) > var_3 )
        {
            var_4 = self _meth_8176( var_0._id_02E6, 1.0 );
...
_id_15F0( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        if ( isdefined( var_3["override_entrances"] ) && var_3["override_entrances"].size > 0 )
        {
            ...
            self._id_27A2 = self._id_02AB + " " + gettime();

            foreach ( var_8 in self._id_27B3 )
            {
                var_8._id_701D[self._id_27A2] = maps\mp\bots\_bots_util::_id_332A( var_8._id_02E6, maps\mp\bots\_bots_util::_id_27A7(), "prone" );
                wait 0.05;
                var_8._id_2480[self._id_27A2] = maps\mp\bots\_bots_util::_id_332A( var_8._id_02E6, maps\mp\bots\_bots_util::_id_27A7(), "crouch" );
                wait 0.05;
            }
        }
    ...
    if ( !isdefined( self._id_15EE ) )
    {
        ...
        if ( !isdefined( var_10 ) && isdefined( self._id_15F6 ) && isdefined( self._id_15F6._id_606E ) )
            var_10 = self._id_15F6._id_606E;
        ...
        if ( !isdefined( var_10 ) )
        {
            ...
            {
                var_14 = vectornormalize( var_12[var_13]._id_02E6 - var_11 );
                var_15 = var_11 + var_14 * 15;

                if ( sighttracepassed( var_15, var_12[var_13]._id_02E6, 0, undefined ) )
                {
                ...
                if ( sighttracepassed( var_15 + ( 0, 0, 55 ), var_12[var_13]._id_02E6 + ( 0, 0, 55 ), 0, undefined ) )
                {
                    var_10 = var_12[var_13];
                    break;
                }
    ...
    for (;;)
    {
        ...
        {
            if ( isdefined( level._id_0886 ) && level._id_0886[self._id_04A8] )
            {
                if ( !_id_A4F0::_id_0CE4( self._id_27B4, "avoid_aerial_enemies" ) )
        ...
        if ( isdefined( self._id_24BB ) || isdefined( self._id_24BC ) )
        {
            ...
            if ( isdefined( self._id_24BC ) )
            {
                ...
                self _meth_8354( self._id_24BC, 0, var_4, var_27, self._id_27A5 );
            }
        ...
        var_24 = _id_A4F0::_id_A06A( var_30, "node_relinquished", "goal_changed", "script_goal_changed", "defend_force_node_recalculation", "bad_path" );
...
_id_8475( var_0 )
{
    ...
    if ( var_0 )
    {
        ...
        if ( self._id_15F7 == "capture_zone" && self _meth_80A9( self._id_15F6 ) )
            return 0;

        return distancesquared( self._id_02E6, self._id_15F2 ) > var_2 * 0.75 * 0.75;
    }
    else if ( self _meth_8375() && distancesquared( self._id_02E6, self._id_15F2 ) < var_2 )
    {
...
_id_27AE()
{
    ...
    for ( var_12 = 0; var_12 < var_11.size; var_12++ )
    {
        ...
        self._id_57FA = _id_A4F0::_id_0CDA( self._id_57FA, var_13 );
    }
    ...
    for ( var_23 = 1; var_23 < var_5.size - 2; var_23++ )
    {
        ...
        {
            if ( !_id_A4F0::_id_A33E( self._id_02E6, self._id_0041, var_24[var_12]._id_02E6, 0 ) )
                continue;
            ...
            for ( var_26 = 0; var_26 < self._id_57FA.size; var_26++ )
            {
                ...
                if ( _func_1FF( var_16._id_02BF, var_24[var_12], 1 ) )
                {
                    var_25 = _id_A4F0::_id_0CDA( var_25, var_24[var_12] );
        ...
        if ( isdefined( var_27 ) )
        {
            ...
            {
                if ( _func_1FF( self._id_57FA[var_12]._id_02BF, var_27, 1 ) )
                {
                    if ( _func_220( self._id_57FA[var_12]._id_02E6, var_27._id_02E6 ) > 3600 )
                        var_28 = _id_A4F0::_id_0CDA( var_28, self._id_57FA[var_12] );
                }
            }
            ...
            if ( var_29 == "goal" )
            {
                ...
                {
                    if ( _func_220( self._id_02E6, var_28[var_12]._id_02E6 ) < 1600 )
                        continue;

                    for ( var_30 = 0; var_28[var_12]._id_3A0F < 18 && var_30 < 3.6; var_30 += 0.25 )
                    {
                        self _meth_836D( var_28[var_12]._id_02E6 + ( 0, 0, self _meth_82F2() ), 0.25, "script_search" );
                        wait 0.25;
                    }
                }
            }
    ...
    if ( isdefined( var_1 ) )
        ...
        self _meth_8354( self._id_24BC, var_21, var_20, var_22 );
}
...
_id_5D6E()
{
    ...
    for (;;)
    {
        if ( distancesquared( self._id_02E6, self._id_15F2 ) < var_0 )
...
_id_5D6D()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_1 ) )
        {
            ...
            {
                if ( _func_1FF( var_1, self._id_57FA[var_3]._id_02BF, 1 ) )
                {
                    var_4 = _id_A4F0::_id_A33E( self._id_02E6, self._id_0041, self._id_57FA[var_3]._id_02E6, var_2 );
                    var_5 = !var_4 || self._id_57FA[var_3]._id_3A0F < 17;

                    if ( var_5 && distancesquared( self._id_02E6, self._id_57FA[var_3]._id_02E6 ) < var_0 )
                    {
                        var_4 = 1;
...
_id_703D()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_7 in var_5 )
        {
            ...
            if ( var_7._id_01E7 == 0 && isdefined( var_7._id_2670 ) && var_4 - var_7._id_2670 < 5000 )
            {
                if ( var_4 - var_7._id_5534 > 10000 && var_4 > var_0[var_8] )
                {
                    if ( isdefined( var_7._id_024A ) && isdefined( var_7._id_024A._id_04A8 ) && var_7._id_024A._id_04A8 == _id_A4F0::_id_3D4D( self._id_04A8 ) )
                    {
                        if ( distancesquared( var_7._id_02E6, self._id_02E6 ) < var_2 )
                        {
                            self _meth_8377( var_7._id_024A, var_7._id_02E6 );
                            var_9 = getclosestnodeinsight( var_7._id_02E6 );

                            if ( isdefined( var_9 ) )
                            {
                                self._id_27B2 = var_9._id_02E6;
...
_id_27B5()
{
    ...
    else if ( maps\mp\bots\_bots_util::_id_1662() || maps\mp\bots\_bots_util::_id_1659() )
    {
        ...
        {
            if ( _func_1FF( var_0, self._id_611F, 1 ) )
                var_1 = _id_A4F0::_id_0CDA( var_1, self._id_611F );
        }
    }
...
_id_16A6()
{
    ...
    for (;;)
    {
        ...
        if ( _id_A4F0::_id_0CE4( self._id_27B4, "strict_los" ) )
        {
            var_1 = 1.0;
            var_2 = 0.5;
        }
        ...
        foreach ( var_4 in self._id_A1E1 )
        {
            ...
            {
                var_4._id_A1E0[self._id_3313] = var_1;
                continue;
            }

            var_4._id_A1E0[self._id_3313] = var_2;
        }
        ...
        foreach ( var_4 in self._id_A1E1 )
        {
            if ( var_6 )
            {
                ...
                var_4._id_A1E0[self._id_3313] *= var_8;
            }

            if ( _id_332D( var_4 ) )
                var_4._id_A1E0[self._id_3313] *= 0.5;
        }
...
_id_16A7()
{
    ...
    for (;;)
    {
        var_0 = anglestoforward( self._id_15EE._id_0041 ) * ( 1, 1, 0 );
        var_0 = vectornormalize( var_0 );

        foreach ( var_2 in self._id_A1E1 )
        {
            var_2._id_A1E0[self._id_3313] = 1.0;
            var_3 = var_2._id_02E6 - self._id_15EE._id_02E6;
            var_3 = vectornormalize( var_3 );
            var_4 = vectordot( var_0, var_3 );

            if ( var_4 > 0.6 )
                var_2._id_A1E0[self._id_3313] *= 0.33;
            else if ( var_4 > 0 )
                var_2._id_A1E0[self._id_3313] *= 0.66;

            if ( !_id_3329( var_2 ) )
                var_2._id_A1E0[self._id_3313] *= 0.5;
        }
...
_id_3329( var_0 )
{
    ...
    {
        if ( botzonegetcount( var_3, self._id_04A8, "enemy_predict" ) > 0 )
        {
            if ( isdefined( var_1 ) && var_3 == var_1 )
                return 1;
            else
            {
                var_4 = vectornormalize( _func_205( var_3 ) - self._id_02E6 );
...
_id_6FBA( var_0 )
{
    ...
    {
        if ( botzonegetcount( var_2, self._id_04A8, "enemy_predict" ) <= 0 )
            continue;

        if ( var_1.size == 0 )
            break;

        var_3 = vectornormalize( _func_205( var_2 ) - self._id_02E6 );
        ...
        for ( var_4 = 0; var_4 < var_1.size; var_4++ )
        {
            ...
            {
                var_7 = vectornormalize( var_1[var_4]._id_02E6 - self._id_02E6 );
            ...
            if ( var_6 )
            {
                var_1[var_4]._id_A1E0[self._id_3313] *= var_0;
...
_id_332E( var_0, var_1 )
{
    ...
    var_3 = vectornormalize( var_1._id_02E6 - var_0._id_02E6 );
...
_id_163F( var_0, var_1 )
{
    ...
    foreach ( var_5 in var_3 )
    {
        if ( !isai( var_5 ) || var_5 maps\mp\bots\_bots_util::_id_165E( var_0 ) )
            var_2 = _id_A4F0::_id_0CDA( var_2, var_5 );
    }
...
_id_1640( var_0, var_1 )
{
    ...
    for ( var_4 = 0; var_4 < level._id_669A.size; var_4++ )
    {
        var_5 = level._id_669A[var_4];

        if ( var_5 != self && isdefined( var_5._id_04A8 ) && var_5._id_04A8 == self._id_04A8 && _id_A75A::_id_51CB( var_5 ) )
        {
            if ( distancesquared( var_0, var_5._id_02E6 ) < var_2 )
...
_id_27A4( var_0 )
{
    ...
    foreach ( var_3 in level._id_669A )
    {
        ...
        if ( var_3._id_04A8 == self._id_04A8 && var_3 != self && isai( var_3 ) && var_3 maps\mp\bots\_bots_util::_id_165D() && var_3._id_24BD == var_0 )
        {
...
_id_5D7F()
{
    ...
    for (;;)
    {
        ...
        self._id_15F2 = self._id_15EE._id_02E6;
        ...
        if ( self _meth_835D() != "none" )
        {
            ...
            var_6 = self._id_15EE _meth_8339();
            ...
            if ( var_7 > 100 )
            {
                ...
                if ( distancesquared( var_2, self._id_15EE._id_02E6 ) > var_1 * var_1 )
                {
                    var_2 = self._id_15EE._id_02E6;
                    var_4 = 1;
                    var_8 = vectornormalize( var_5 - self._id_15EE._id_02E6 );
            ...
            if ( abs( self._id_15EE._id_02E6[2] - var_5[2] ) >= 50 )
            {
                self notify( "defend_force_node_recalculation" );
                wait 0.25;
            }
...
_id_375D()
{
    ...
    if ( isdefined( var_1 ) )
    {
        if ( isdefined( var_0 ) )
        {
            var_2 = vectornormalize( var_0 - var_1._id_02E6 );
            self._id_24BA = vectortoangles( var_2 );
        }
        else
        {
            var_3 = vectornormalize( var_1._id_02E6 - maps\mp\bots\_bots_util::_id_27A7() );
...
_id_3760()
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_1 = vectornormalize( maps\mp\bots\_bots_util::_id_27A7() - var_0._id_02E6 );
...
_id_15D5( var_0, var_1, var_2, var_3 )
{
    for ( var_4 = 0; var_4 < level._id_669A.size; var_4++ )
    {
        ...
        if ( var_5._id_04A8 == self._id_04A8 && var_5 != self )
        {
            if ( isai( var_5 ) )
            {
                if ( var_2 )
                {
                    if ( distancesquared( var_0, var_5._id_02E6 ) < 441 )
                        return 1;
                }
...
_id_15D3()
{
    ...
    if ( isdefined( self._id_15F3 ) )
    {
        ...
        {
            var_3 = distance( self._id_15F2, var_2._id_02E6 );
    ...
    for (;;)
    {
        if ( self._id_90A8.size > 0 && !maps\mp\bots\_bots_util::_id_1664() )
        {
            ...
            if ( !isdefined( var_0._id_06BA ) )
            {
                ...
                self _meth_8354( var_0._id_424C, var_0._id_424D, var_1, var_0._id_01C4, var_0._id_62F0 );
            ...
            self._id_90A8 = _id_A4F0::_id_0CF6( self._id_90A8, var_0 );
        }
...
{
    var_4 = spawnstruct();
    var_4._id_04D8 = var_0;
    var_4._id_424C = var_1;

    if ( isdefined( self._id_64B6 ) )
    {
        if ( !_id_A4F0::_id_0CE4( self._id_64B6, var_0 ) )
            return;
    }

    var_4._id_6FBB = var_2;
    ...
    {
        if ( var_4._id_6FBB > self._id_90A8[var_5]._id_6FBB )
            break;
    }
...
_id_15F9()
{
    ...
    {
        if ( var_1._id_04D8 != "map_interactive_object" )
            var_1._id_06BA = 1;
    }
}
...
_id_16A0()
{
    ...
    if ( !isdefined( self._id_553B ) || var_0 - self._id_553B > 1000 )
    {
        ...
        var_2 = _func_202( self._id_02E6 );

        if ( !isdefined( var_2 ) )
            return 0;

        var_3 = botzonenearestcount( var_2, self._id_04A8, 1, "enemy_predict", ">", 0 );

        if ( !isdefined( var_3 ) )
            return 0;

        var_4 = getnodesinradius( self._id_02E6, 500, 0 );
