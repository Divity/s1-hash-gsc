...
_id_15AD()
{
    ...
    self._id_030D["personality"] = self._id_67DC;
...
_id_15B0()
{
    ...
    if ( isdefined( self._id_030D["personality"] ) )
    {
        self _meth_8369( self._id_030D["personality"] );
        return;
    }
    ...
    {
        if ( _id_A75A::_id_51CB( var_10 ) && isdefined( var_10._id_04A8 ) && var_10._id_04A8 == var_0 && var_10 != self && isdefined( var_10._id_46DD ) )
        {
    ...
    var_18 = undefined;
    var_19 = -9999;
    var_20 = _id_A4F0::_id_0CF5( level._id_16B0[var_12] );
    ...
    if ( var_19 - var_17 >= 2 )
        ...
        var_15 = _id_A4F0::_id_710B( level._id_16B0[var_12] );
...
_id_9ACA()
{
    ...
    if ( !maps\mp\bots\_bots_strategy::_id_1649() && !maps\mp\bots\_bots_util::_id_1664() )
    {
        ...
        if ( var_1 )
        {
            var_2 = distancesquared( self._id_02E6, var_0 );
...
_id_171B( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) && self _meth_8341() )
    {
        ...
        if ( var_3.size > 0 )
        {
            ...
            _id_A4F0::_id_A06A( 5, "grenade_fire", "missile_fire" );
        }
    }
}
...
_id_1ED2( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    while ( var_6 )
    {
        var_7 = _id_A4F0::_id_A067( var_0, var_1, var_2, var_3, var_4, "script_goal_changed" );
        var_6 = 0;
        var_8 = 1;
...
_id_16A8()
{
    ...
    while ( isdefined( self._id_A1E1 ) )
    {
        foreach ( var_1 in self._id_A1E1 )
            var_1._id_A1E0[self._id_3313] = 1.0;
...
_id_160F( var_0, var_1 )
{
    self endon( "disconnect" );
    var_2 = [];
    var_3 = _func_20D( var_0._id_02E6 );

    if ( isdefined( var_3 ) && var_3.size > 0 )
    {
        wait 0.05;
        var_4 = var_0._id_04D8 != "Cover Stand" && var_0._id_04D8 != "Conceal Stand";

        if ( var_4 && var_1 )
            var_3 = self _meth_8380( var_3, "node_exposure_vis", var_0._id_02E6, "crouch" );

        foreach ( var_6 in var_3 )
        {
            if ( distancesquared( self._id_02E6, var_6._id_02E6 ) < 90000 )
                continue;
            ...
            if ( var_4 && var_1 )
            {
                ...
                if ( !maps\mp\bots\_bots_util::_id_332A( var_6._id_02E6, var_0._id_02E6, "crouch" ) )
                    continue;
            }
...
_id_160C( var_0, var_1, var_2 )
{
    ...
    if ( level._id_91E4 )
    {
        foreach ( var_7 in level._id_669A )
        {
            if ( !_id_A75A::_id_5186( var_7 ) )
                continue;

            if ( !isdefined( var_7._id_04A8 ) )
                continue;

            if ( var_7._id_04A8 == var_1._id_04A8 && var_7 != var_1 && isdefined( var_7._id_611E ) )
                var_4[var_4.size] = var_7._id_611E._id_02E6;
        }
    }
    ...
    for ( var_11 = 0; var_11 < var_10; var_11++ )
    {
        ...
        {
            var_15 = distancesquared( var_4[var_14], var_13._id_02E6 );
            var_12 = var_15 < var_5;
        }
...
_id_3756()
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_4 = botzonenearestcount( var_0, self._id_04A8, -1, "enemy_predict", ">", 0, "ally", "<", 1 );

        if ( !isdefined( var_4 ) )
            var_4 = botzonenearestcount( var_0, self._id_04A8, -1, "enemy_predict", ">", 0 );
        ...
        if ( !isdefined( var_4 ) )
        {
            ...
            for ( var_9 = 0; var_9 < level._id_A3E6; var_9++ )
            {
                ...
                if ( var_6.size > 0 )
                {
                    var_10 = _id_A4F0::_id_710B( _func_203( var_9 ) );
                    var_11 = isdefined( var_10._id_04A7 ) && var_10._id_04A7 == "no_bot_random_path";

                    if ( !var_11 )
                    {
                        var_12 = _func_220( _func_205( var_9 ), self._id_02E6 );
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        while ( var_16 )
        {
            ...
            if ( var_19.size > 0 )
            {
                ...
                if ( var_19.size > 0 )
                    var_15 = _id_A4F0::_id_7119( var_19 );
            }
...
_id_3751( var_0, var_1 )
{
    ...
    {
        var_2 = undefined;
        var_3 = getnodesinradius( self._id_02E6, 5000, 0, 2000 );

        if ( var_3.size > 0 )
            var_2 = self _meth_8364( var_3, var_3.size * 0.25, "node_traffic" );

        if ( isdefined( var_2 ) )
            self._id_6E1E = var_2._id_02E6;
        else
            return 0;
    }
    ...
    self._id_0B61 = gettime() + self._id_0B60;
    self._id_611E._id_15AC = self._id_0B61;
    var_8 = vectornormalize( self._id_6E1E - self._id_611E._id_02E6 );
...
_id_16C7()
{
    ...
    var_0 = level._id_16C9[self._id_04A8];
    return self [[ var_0 ]]();
}
