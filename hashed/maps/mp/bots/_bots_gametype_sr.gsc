...
_id_806C()
{
    level._id_161B["gametype_think"] = ::_id_1704;
}
...
_id_90D5()
{
    for (;;)
    {
        ...
        if ( var_0.size > 0 )
        {
            ...
            if ( distancesquared( self._id_02E6, var_1._id_0429._id_24C8 ) < 10000 )
                _id_8AD7( var_1._id_0429 );
            else if ( self._id_04A8 == game["attackers"] )
            {
...
_id_8AD7( var_0 )
{
    if ( isdefined( var_0._id_16B8 ) && isdefined( var_0._id_16B8[self._id_04A8] ) && isalive( var_0._id_16B8[self._id_04A8] ) && var_0._id_16B8[self._id_04A8] != self )
        return;
    ...
    if ( var_2 == "no_path" )
    {
        ...
        if ( var_2 == "no_path" )
        {
            var_1 = maps\mp\bots\_bots_util::_id_16C3( "BotGetClosestNavigablePoint", maps\mp\bots\_bots_util::_id_3AE3, var_0._id_24C8, 32, self );
    ...
    {
        var_3 = getnodesinradiussorted( var_0._id_24C8, 256, 0, level._id_1709 + 55 );

        if ( var_3.size > 0 )
        {
            var_4 = ( var_0._id_24C8[0], var_0._id_24C8[1], ( var_3[0]._id_02E6[2] + var_0._id_24C8[2] ) * 0.5 );
            self _meth_8354( var_4, 0, "tactical" );
            var_2 = maps\mp\bots\_bots_util::_id_172E( undefined, "tag_picked_up", "new_role" );
        }
    }

    if ( var_2 == "goal" && var_0 _id_A78A::_id_1ACA( self._id_04A8 ) )
        wait 3.0;
    ...
    var_0._id_16B8[self._id_04A8] = undefined;
    self._id_8FF9 = undefined;
}
...
_id_A1EC( var_0 )
{
    ...
    for (;;)
    {
        if ( !var_0 _id_A78A::_id_1ACA( self._id_04A8 ) )
            wait 0.05;
...
_id_8AD5( var_0 )
{
    var_1 = distance( self._id_02E6, var_0._id_24C8 );
    var_2 = maps\mp\bots\_bots_gametype_sd::_id_3DC7( self._id_04A8, 1 );

    foreach ( var_4 in var_2 )
    {
        if ( var_4 != self && isdefined( var_4._id_7597 ) && var_4._id_7597 != "atk_bomber" && var_4._id_7597 != "bomb_defuser" )
        {
            var_5 = distance( var_4._id_02E6, var_0._id_24C8 );
...
_id_6220( var_0, var_1 )
{
    ...
    while ( var_0 _id_A78A::_id_1ACA( self._id_04A8 ) && !maps\mp\bots\_bots_gametype_conf::_id_15D4( var_0 ) )
        wait 0.05;
...
_id_8AD6( var_0 )
{
    if ( isdefined( var_0._id_15C4 ) && isdefined( var_0._id_15C4[self._id_04A8] ) && isalive( var_0._id_15C4[self._id_04A8] ) && var_0._id_15C4[self._id_04A8] != self )
        return;
    ...
    var_0._id_15C4[self._id_04A8] = self;
    ...
    while ( var_0 _id_A78A::_id_1ACA( self._id_04A8 ) && self._id_7597 == var_1 )
    {
        if ( maps\mp\bots\_bots_personality::_id_8470() )
        {
            if ( maps\mp\bots\_bots_personality::_id_3751( var_0._id_24C8, 1000 ) )
    ...
    self _meth_8356();
    var_0._id_15C4[self._id_04A8] = undefined;
    self._id_8FF9 = undefined;
}
