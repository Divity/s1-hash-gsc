    ...
    for (;;)
    {
        ...
        foreach ( var_12 in var_9 )
        {
            foreach ( var_14 in var_10 )
            {
                ...
                var_15._id_0257[var_15._id_0257.size] = var_16;
            }
        }
    }
}
...
_id_1682( var_0 )
{
    ...
    {
        var_6 = _id_A4F0::_id_0CF5( level._id_16B1 );
...
_id_1693()
{
    if ( !isdefined( level._id_91E4 ) || !level._id_91E4 )
        return "allies";
...
_id_16B5( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            ...
            if ( var_2.size > 0 )
                maps\mp\bots\_bots_util::_id_16ED( _id_A4F0::_id_710B( var_2 ) );
        }
    }
}
...
_id_1690( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) && isdefined( var_2._id_0257 ) && var_2._id_0257.size > 0 )
    {
        var_3 = randomint( var_2._id_0257.size );
        return var_2._id_0257[var_3]._id_57E4;
    }
}
...
_id_1728( var_0, var_1, var_2, var_3 )
{
    ...
    var_6 = _id_A75A::_id_415D( var_0 );

    for ( var_7 = var_5; var_7 < var_4.size; var_7++ )
    {
        var_8 = _id_A75A::_id_0E02( var_4[var_7] );
        ...
        if ( !_id_A4F0::_id_0CE4( var_6, var_4[var_7] ) )
            return 0;
...
_id_4CBD()
{
    ...
    for (;;)
    {
        ...
        if ( var_8 != "" && var_7 != "" && var_9 != "" )
        {
            ...
            if ( _id_A75A::_id_514A( var_7 ) )
                var_10 = _id_A781::_id_3F0E( var_7 );

            var_11 = "loadoutPrimary";

            if ( _id_A781::_id_51F2( var_10, 0 ) )
                var_11 = "loadoutSecondary";
            else if ( !_id_A781::_id_51F0( var_10 ) )
            {
                var_5++;
                continue;
            }
...
_id_1686( var_0, var_1 )
{
    ...
    {
        case "loadoutPrimary":
            return _id_A781::_id_909D( level._id_1E3D, var_2, 0 );
        case "loadoutPrimaryAttachment":
            return _id_A781::_id_909E( level._id_1E3D, var_2, 0, 0 );
        case "loadoutPrimaryAttachment2":
            return _id_A781::_id_909E( level._id_1E3D, var_2, 0, 1 );
        case "loadoutPrimaryAttachment3":
            return _id_A781::_id_909E( level._id_1E3D, var_2, 0, 2 );
        case "loadoutPrimaryCamo":
            return _id_A781::_id_90A0( level._id_1E3D, var_2, 0 );
        case "loadoutPrimaryReticle":
            return _id_A781::_id_90A1( level._id_1E3D, var_2, 0 );
        case "loadoutSecondary":
            return _id_A781::_id_909D( level._id_1E3D, var_2, 1 );
        case "loadoutSecondaryAttachment":
            return _id_A781::_id_909E( level._id_1E3D, var_2, 1, 0 );
        case "loadoutSecondaryAttachment2":
            return _id_A781::_id_909E( level._id_1E3D, var_2, 1, 1 );
        case "loadoutSecondaryAttachment3":
            return _id_A781::_id_909E( level._id_1E3D, var_2, 1, 2 );
        case "loadoutSecondaryCamo":
            return _id_A781::_id_90A0( level._id_1E3D, var_2, 1 );
        case "loadoutSecondaryReticle":
            return _id_A781::_id_90A1( level._id_1E3D, var_2, 1 );
        case "loadoutEquipment":
            return _id_A781::_id_9095( level._id_1E3D, var_2 );
        case "loadoutEquipment2":
            return tablelookup( level._id_1E3D, 0, "loadoutEquipment2", var_2 + 1 );
        case "loadoutOffhand":
            return _id_A781::_id_9099( level._id_1E3D, var_2 );
        case "loadoutOffhand2":
            if ( _id_A781::_id_909A( level._id_1E3D, var_2 ) )
                return _id_A781::_id_9099( level._id_1E3D, var_2 );
            else
                return "specialty_null";
        case "loadoutStreak1":
            return _id_A781::_id_9097( level._id_1E3D, var_2, 0 );
        case "loadoutStreakModule1a":
            return _id_A781::_id_9098( level._id_1E3D, var_2, 0, 0 );
        case "loadoutStreakModule1b":
            return _id_A781::_id_9098( level._id_1E3D, var_2, 0, 1 );
        case "loadoutStreakModule1c":
            return _id_A781::_id_9098( level._id_1E3D, var_2, 0, 2 );
        case "loadoutStreak2":
            return _id_A781::_id_9097( level._id_1E3D, var_2, 1 );
        case "loadoutStreakModule2a":
            return _id_A781::_id_9098( level._id_1E3D, var_2, 1, 0 );
        case "loadoutStreakModule2b":
            return _id_A781::_id_9098( level._id_1E3D, var_2, 1, 1 );
        case "loadoutStreakModule2c":
            return _id_A781::_id_9098( level._id_1E3D, var_2, 1, 2 );
        case "loadoutStreak3":
            return _id_A781::_id_9097( level._id_1E3D, var_2, 2 );
        case "loadoutStreakModule3a":
            return _id_A781::_id_9098( level._id_1E3D, var_2, 2, 0 );
        case "loadoutStreakModule3b":
            return _id_A781::_id_9098( level._id_1E3D, var_2, 2, 1 );
        case "loadoutStreakModule3c":
            return _id_A781::_id_9098( level._id_1E3D, var_2, 2, 2 );
        case "loadoutStreak4":
            return _id_A781::_id_9097( level._id_1E3D, var_2, 3 );
        case "loadoutStreakModule4a":
            return _id_A781::_id_9098( level._id_1E3D, var_2, 3, 0 );
        case "loadoutStreakModule4b":
            return _id_A781::_id_9098( level._id_1E3D, var_2, 3, 1 );
        case "loadoutStreakModule4c":
            return _id_A781::_id_9098( level._id_1E3D, var_2, 3, 2 );
        case "loadoutPerk3":
        case "loadoutPerk4":
        case "loadoutPerk5":
        case "loadoutPerk6":
        ...
        case "loadoutPerk2":
            ...
            var_4 = _id_A781::_id_909B( level._id_1E3D, var_2, var_3 );
        ...
        case "loadoutWildcard1":
            return _id_A781::_id_90A2( level._id_1E3D, var_2, 0 );
        case "loadoutWildcard2":
            return _id_A781::_id_90A2( level._id_1E3D, var_2, 1 );
        case "loadoutWildcard3":
            return _id_A781::_id_90A2( level._id_1E3D, var_2, 2 );
    }
    ...
    for (;;)
    {
        ...
        if ( var_5 != "" && var_6 != "" )
        {
            ...
            foreach ( var_10 in var_8 )
            {
                ...
                if ( !_id_A4F0::_id_0CE4( level._id_15AF[var_10], var_5 ) )
                {
...
_id_168F( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( self._id_7133 ) )
    {
        ...
        {
            self._id_7133 = self._id_030D["rank"];
...
_id_1694( var_0, var_1, var_2, var_3 )
{
    ...
    switch ( var_2 )
    {
        case "loadoutPrimary":
            ...
            var_4 = var_4 && _id_A781::_id_51F0( var_3 );
            break;
        case "loadoutEquipment":
            var_4 = _id_168E( "perk", var_3, "Lethal" );
            var_4 = var_4 && _id_A781::_id_51E7( var_3, _id_1692( var_1, "specialty_wildcard_dualtacticals" ) );
        ...
        case "loadoutOffhand":
            ...
            var_4 = var_4 && _id_A781::_id_51EF( var_3, _id_1692( var_1, "specialty_wildcard_duallethals" ) );
            var_4 = var_4 && _id_168F( var_0, var_3, self _meth_836B() );
            break;
        case "loadoutOffhand2":
        ...
        case "loadoutPrimaryCamo":
            ...
            var_4 = var_4 && _id_A781::_id_51E4( var_3 );
            break;
        case "loadoutSecondary":
            ...
            var_4 = var_4 && _id_A781::_id_51F2( var_3, _id_1692( var_1, "specialty_wildcard_dualprimaries" ) );
            break;
        case "loadoutSecondaryAttachment":
...
_id_1688( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( _id_A4F0::_id_0CE4( var_0, "specialty_null" ) )
        var_5 = "specialty_null";
    else if ( var_3 == "loadoutEquipment" || var_3 == "loadoutOffhand" || _id_A4F0::_id_8F4F( var_3, "Perk" ) >= 0 )
        var_5 = "specialty_null";

    if ( var_1 == "classtable_any" )
    {
        if ( !isdefined( self._id_2778 ) )
            self._id_2778 = _id_A4F0::_id_710B( [ "class1", "class2", "class3", "class4", "class5" ] );
...
_id_168A( var_0 )
{
    ...
    if ( self _meth_836B() != "recruit" )
    {
        ...
        for ( var_8 = 0; var_7 < level._id_2558 && var_8 < 5; var_8++ )
        {
            if ( var_7 == level._id_2558 - 1 )
                var_0 = _id_160D( var_0 );
            else if ( var_7 <= level._id_2558 - 2 )
...
_id_160D( var_0 )
{
    ...
    if ( _id_1639( var_0 ) == level._id_2558 )
        return var_0;
    ...
    if ( var_2 == "remove" )
    {
        if ( var_0["loadoutEquipment"] != "specialty_null" )
        {
            ...
            if ( _id_1639( var_0 ) == level._id_2558 - 2 )
                return var_0;
        }
    }
    else if ( var_2 == "add" )
...
_id_160E( var_0 )
{
    ...
    var_2 = _id_A4F0::_id_0CF5( [ "loadoutPerk2", "loadoutPerk4", "loadoutPerk6" ] );
...
_id_168B( var_0 )
{
    ...
    else
    {
        ...
        if ( isdefined( level._id_161B["gametype_loadout_modify"] ) )
            var_3 = self [[ level._id_161B["gametype_loadout_modify"] ]]( var_3 );
    }
    ...
    _id_A781::_id_51EB( var_3["loadoutStreak1"] );
    _id_A781::_id_51EB( var_3["loadoutStreak2"] );
    _id_A781::_id_51EB( var_3["loadoutStreak3"] );
    self._id_15E7++;
    self._id_173C = var_3;
    self._id_173D = var_4;
    self._id_173E = var_5;
...
_id_16F4()
{
    ...
    var_3 = getsubstr( self._id_02AB, 0, self._id_02AB.size - 10 );
