...
_id_1679( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( self._id_0143 ) && self._id_0143._id_01E7 > 0 && self _meth_836F( self._id_0143 ) )
        return 1;
...
_id_15CC( var_0 )
{
    foreach ( var_2 in var_0._id_5D57 )
    {
...
_id_16DD( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_4 ) )
    {
        ...
        self._id_6867 = var_0._id_8F20;
        maps\mp\bots\_bots_strategy::_id_16A9( "sentry_placement", var_4._id_02BF._id_02E6, 0, var_5 );
    }
}
...
_id_16E6( var_0 )
{
    ...
    while ( isdefined( var_0._id_62DE ) && isdefined( var_0._id_62DE._id_0512 ) )
    {
        if ( distance2d( self._id_02E6, var_0._id_62DE._id_02BF._id_02E6 ) < 400 )
        {
            thread maps\mp\bots\_bots_util::_id_161A( "stand", 5.0 );
            thread _id_16DF();
            maps\mp\bots\_bots_ks::_id_1708( var_0._id_62DE._id_5385, var_0._id_62DE._id_53A1, var_0._id_62DE._id_0512 );
            return;
        }
...
_id_16E2( var_0 )
{
    ...
    if ( isdefined( self._id_611E ) )
        return self._id_611E._id_02E6;

    var_2 = getnodesinradius( self._id_02E6, 1000, 0, 512 );
    var_3 = 5;
...
_id_16E1( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_7 ) )
    {
        ...
        if ( var_1 != var_7._id_02E6 && var_2 != "hide_nonlethal" )
            var_4._id_A3AB = vectortoyaw( var_1 - var_7._id_02E6 );
        else
            var_4._id_A3AB = undefined;

        var_4._id_0512 = var_0._id_0512;
...
_id_16DC( var_0 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        if ( !var_2._id_1AAE )
        {
            ...
            {
                var_11 = playerphysicstrace( var_0._id_62DE._id_02BF._id_02E6, var_0._id_62DE._id_02BF._id_02E6 + anglestoforward( ( 0, var_10 + 180, 0 ) ) * 100 );
                var_12 = distance2d( var_11, var_0._id_62DE._id_02BF._id_02E6 );

                if ( var_12 < var_8 )
                {
                    var_8 = var_12;
                    self _meth_8353( var_10, var_4 );
                    self _meth_836D( var_0._id_62DE._id_02BF._id_02E6, var_4, "script_forced" );
                }
            }
...
{
    if ( isdefined( self._id_1BAD ) )
        self._id_1BAD _id_A7BA::_id_7CB7();

    if ( isdefined( self._id_1BAE ) )
        self._id_1BAE _id_A7CD::_id_997F();

    if ( isdefined( self._id_1BAB ) )
        self._id_1BAB _id_A7CC::_id_6454( self._id_6867, 0 );
