...
_id_2F8E( var_0, var_1 )
{
    ...
    var_4 = self _meth_83E5( var_2, var_3, self._id_0354, self._id_01E9, 1 );
...
_id_1AD2( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = var_0 + var_4;
    var_6 = var_1 + var_4;
    return self _meth_83E6( var_5, var_6, var_3, self._id_01E9 - var_2, 1 );
}
...
_id_4149( var_0, var_1, var_2 )
{
    ...
    var_4 = var_0 + var_3;
    var_5 = var_1 + var_3;
    return self _meth_83E5( var_4, var_5, self._id_0354 + 4, self._id_01E9 - var_2, 1 );
}
...
_id_40BE( var_0 )
{
    ...
    var_3 = _id_4149( self._id_02E6, var_2 );
    var_4 = distance( self._id_02E6, var_3 );
    var_5 = distance( self._id_02E6, var_2 );
...
_id_3EF0( var_0 )
{
    ...
    var_2 = angleclamp180( var_1[1] - self._id_0041[1] );
