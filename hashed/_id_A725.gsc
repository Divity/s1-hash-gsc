...
_id_64C5()
{
    for (;;)
    {
        ...
        if ( !isdefined( var_0._id_030D["stats"] ) )
            var_0._id_030D["stats"] = [];

        var_0._id_8D71 = var_0._id_030D["stats"];

        if ( !var_0._id_8D71.size )
        {
            foreach ( var_3, var_2 in level._id_005F )
                var_0 _id_A75A::_id_4DFD( var_3, level._id_005F[var_3]._id_27A0 );
        }
    }
}
...
_id_19DF( var_0 )
{
    var_1 = var_0 _id_A75A::_id_408D( "kills" );
    var_2 = var_0 _id_A75A::_id_408D( "deaths" );

    if ( var_2 == 0 )
        var_2 = 1;

    var_0 _id_A75A::_id_7FE4( "kdratio", var_1 / var_2 );
}

_id_4134( var_0 )
{
    var_1 = var_0._id_0390;

    if ( !level._id_91E4 )
        var_1 = var_0._id_0169;
...
_id_19E6( var_0 )
{
    if ( var_0._id_936B["total"] < 1 )
        return;

    var_1 = _id_4134( var_0 );
    var_2 = var_0._id_936B["total"];
    var_3 = var_1 / ( var_2 / 60 );
    var_0 _id_A75A::_id_7FE4( "totalGameScore", var_1 );
    var_0 _id_A75A::_id_7FE4( "scorePerMinute", var_3 );
}
...
_id_0D70()
{
    foreach ( var_1 in level._id_0328 )
    {
        ...
        var_1 _id_A75A::_id_4C2C( "numMatchesRecorded", 1 );
        _id_19DF( var_1 );
        _id_19E6( var_1 );
    }
...
_id_3F9E( var_0, var_1 )
{
    ...
    {
        case "float":
            var_1 = _id_A75A::_id_5761( var_1, 2 );
            var_1 *= 100;
            break;
        case "none":
        case "distance":
...
_id_488B( var_0, var_1 )
{
    ...
    {
        if ( var_3 _id_A75A::_id_7136() && var_3 _id_8D78( var_0 ) && ( !isdefined( var_1 ) || var_3 _id_A75A::_id_408D( var_0 ) >= var_1 ) )
        {
            var_4 = var_3 _id_A75A::_id_408D( var_0 );
...
_id_58AA( var_0 )
{
    var_1 = _id_A75A::_id_412A() / 1000;
    var_2 = var_1 * 0.5;

    foreach ( var_4 in level._id_0328 )
    {
        if ( var_4._id_4742 && var_4._id_936B["total"] >= var_2 )
        {
            var_5 = var_4 _id_A75A::_id_408D( var_0 );
