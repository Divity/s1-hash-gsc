...
main()
{
    ...
    foreach ( var_3 in var_1 )
        var_0 = _id_A4F0::_id_0CDD( var_0, getentarray( var_3, "classname" ) );

    _id_A4F0::_id_0D13( var_0, ::_id_7A50 );
}
...
_id_7A50()
{
    ...
    if ( isdefined( self._id_04A5 ) )
        var_0 = _id_A4F0::_id_40FB( self._id_04A5, "targetname" );
        ...
        switch ( var_2._id_039B )
        {
            case "origin":
                if ( !isdefined( var_2._id_0041 ) )
                    var_2._id_0041 = ( 0, 0, 0 );

                self._id_6590 = spawn( "script_model", var_2._id_02E6 );
                self._id_6590._id_0041 = var_2._id_0041;
                self._id_6590 _meth_80B1( "tag_origin" );
                self._id_6590 _meth_804D( self );
                continue;
            case "scripted_node":
            case "scene_node":
                if ( !isdefined( var_2._id_0041 ) )
    ...
    if ( isdefined( self._id_04A5 ) )
        var_4 = getentarray( self._id_04A5, "targetname" );
...
_id_7A62()
{
    self._id_5F69 = self._id_02E6;
    self._id_5F68 = self._id_0041;
}
...
_id_7A61( var_0 )
{
    ...
    self._id_02E6 = self._id_5F69;
    self._id_0041 = self._id_5F68;
    ...
    for ( var_2 = 0; var_2 < var_0.size; var_2++ )
    {
        ...
        switch ( var_3._id_039B )
        {
            case "ignore":
                ...
                {
                    var_4 = _id_A4F0::_id_40FB( var_3._id_04A5, "targetname" );
...
_id_7A60( var_0, var_1 )
{
    ...
    if ( isdefined( self._id_7B33 ) )
        self _meth_848B( var_0._id_0C72, self._id_7B33._id_02E6, self._id_7B33._id_0041, "script_mover_anim" );
    else
        self _meth_827B( var_0._id_0C72, "script_mover_anim" );
}
...
_id_7A57( var_0 )
{
    ...
    {
        var_1 = _id_A4F0::_id_710B( var_0._id_4250 );
        var_2 = self;
        ...
        var_6 = 0;
        var_7 = 0;
        var_8 = transformmove( var_1._id_02E6, var_1._id_0041, self._id_6590._id_02E6, self._id_6590._id_0041, self._id_02E6, self._id_0041 );

        if ( var_2._id_02E6 != var_1._id_02E6 )
        {
            if ( isdefined( var_2._id_6680["move_speed"] ) )
            {
                var_9 = distance( var_2._id_02E6, var_1._id_02E6 );
        ...
        if ( _id_0B9F( var_8["angles"] ) != _id_0B9F( var_2._id_0041 ) )
        {
            if ( var_3 <= 0 )
            {
                var_2 _meth_8092();
                var_2._id_0041 = var_8["angles"];
            }
            else
...
_id_7A51()
{
    ...
    self._id_0041 = _id_0B9F( self._id_0041 );
    _id_7A5D( self._id_7A93 );
}
...
_id_7A66( var_0, var_1 )
{
    if ( var_1 )
    {
        ...
        var_0 _meth_80DB( level._id_7A4F[self._id_6680["hintstring"]] );
    }
    else
        var_0 _meth_80C0();
}
...
_id_9A57( var_0 )
{
    ...
    if ( level._id_91E4 )
    {
        if ( isdefined( var_1._id_02E9._id_04A8 ) && var_1._id_02E9._id_04A8 != var_0._id_04A8 )
            var_2 = 1;
    }
    else if ( var_0 != var_1._id_02E9 )
        var_2 = 1;
    ...
    var_0 _meth_8051( var_3, var_1._id_02E6, var_1._id_02E9, var_1, "MOD_CRUSH" );
}
...
_id_9A54( var_0, var_1 )
{
    ...
    {
        var_2 = getnodesinradius( var_0._id_02E6, 300, 0, 200 );
        var_2 = sortbydistance( var_2, var_0._id_02E6 );
    }
    ...
    var_0 _meth_8439();
    var_0 _meth_8092();
    var_0 _meth_8338( var_0._id_02E6 + var_3 );

    for ( var_4 = 0; var_4 < var_2.size; var_4++ )
    {
        var_5 = var_2[var_4];
        var_6 = var_5._id_02E6;
...
_id_5F6A()
{
    if ( isdefined( level._id_511A ) && !isagent( self ) )
        return;
...
_id_6210()
{
    ...
    foreach ( var_2 in var_0 )
    {
        if ( isdefined( var_2._id_6103 ) && var_2._id_6103 )
            continue;
...
_id_6FEB( var_0, var_1 )
{
    ...
    if ( isdefined( var_0._id_6A3B ) )
        playfx( _id_A4F0::_id_3FA6( "airdrop_crate_destroy" ), self._id_02E6 );

    if ( isdefined( var_0._id_2662 ) )
        self thread [[ var_0._id_2662 ]]( var_0 );
    else
        self delete();
}
...
_id_45BC( var_0 )
{
    ...
    if ( isdefined( var_0._id_31BA ) )
        self endon( var_0._id_31BA );

    if ( isdefined( var_0._id_5791 ) )
        self _meth_804D( var_0._id_5791 );
