...
_id_4DF8()
{
    ...
    self _meth_82FD( "sm_sunenable", self._id_8FC2, "sm_sunshadowscale", self._id_8FD6, "sm_spotlimit", self._id_8A89, "sm_qualityspotshadow", self._id_7080, "sm_sunSampleSizeNear", self._id_8FD5 );
}
...
{
    level notify( "changing_sunsamplesizenear" + var_3._id_02AB );
    level endon( "changing_sunsamplesizenear" + var_3._id_02AB );
